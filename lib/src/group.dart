...
class Group extends DomainResource implements FhirResource {
  ...
  final String type; // Possible values: 'person', 'animal', 'practitioner', 'device', 'medication', 'substance'
  Group({
    this.active,
  ...
  factory Group.fromJson(Map<String, dynamic> json) {
    return Group(
      ...
      characteristic: (json['characteristic'] as List<dynamic>?)?.map((e) => GroupCharacteristic.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      managingEntity: json['managingEntity'] != null ? Reference.fromJson(json['managingEntity'] as Map<String, dynamic>) : null,
      member: (json['member'] as List<dynamic>?)?.map((e) => GroupMember.fromJson(e as Map<String, dynamic>)).toList(),
