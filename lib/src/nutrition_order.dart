...
class NutritionOrder extends DomainResource implements FhirResource {
  ...
  factory NutritionOrder.fromJson(Map<String, dynamic> json) {
    return NutritionOrder(
      allergyIntolerance: (json['allergyIntolerance'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      enteralFormula: json['enteralFormula'] != null ? NutritionOrderEnteralFormula.fromJson(json['enteralFormula'] as Map<String, dynamic>) : null,
      excludeFoodModifier: (json['excludeFoodModifier'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      foodPreferenceModifier: (json['foodPreferenceModifier'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      identifier: (json['identifier'] as List<dynamic>?)?.map((e) => Identifier.fromJson(e as Map<String, dynamic>)).toList(),
      implicitRules: json['implicitRules'] as String?,
      instantiates: (json['instantiates'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      oralDiet: json['oralDiet'] != null ? NutritionOrderOralDiet.fromJson(json['oralDiet'] as Map<String, dynamic>) : null,
      orderer: json['orderer'] != null ? Reference.fromJson(json['orderer'] as Map<String, dynamic>) : null,
      patient: Reference.fromJson(json['patient'] as Map<String, dynamic>),
      status: json['status'] as String,
      supplement: (json['supplement'] as List<dynamic>?)?.map((e) => NutritionOrderSupplement.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      'allergyIntolerance': allergyIntolerance?.map((e) => e.toJson()).toList(),
      'contained': contained?.map((e) => e.toJson()).toList(),
      'dateTime': dateTime,
      'encounter': encounter?.toJson(),
      'enteralFormula': enteralFormula?.toJson(),
      'excludeFoodModifier': excludeFoodModifier?.map((e) => e.toJson()).toList(),
      'extension': fhirExtension?.map((e) => e.toJson()).toList(),
      'foodPreferenceModifier': foodPreferenceModifier?.map((e) => e.toJson()).toList(),
      'id': id,
  ...
  NutritionOrder copyWith({
    ...
    return NutritionOrder(
      ...
      foodPreferenceModifier: foodPreferenceModifier ?? this.foodPreferenceModifier,
      id: id ?? this.id,
