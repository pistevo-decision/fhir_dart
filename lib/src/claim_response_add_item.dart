...
class ClaimResponseAddItem extends BackboneElement implements FhirResource {
  ...
  factory ClaimResponseAddItem.fromJson(Map<String, dynamic> json) {
    return ClaimResponseAddItem(
      ...
      detail: (json['detail'] as List<dynamic>?)?.map((e) => ClaimResponseAddItemDetail.fromJson(e as Map<String, dynamic>)).toList(),
