...
class CapabilityStatementRest extends BackboneElement implements FhirResource {
  ...
  factory CapabilityStatementRest.fromJson(Map<String, dynamic> json) {
    return CapabilityStatementRest(
      compartment: (json['compartment'] as List<dynamic>?)?.map((e) => e as String).toList(),
      documentation: json['documentation'] as String?,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      interaction: (json['interaction'] as List<dynamic>?)?.map((e) => CapabilityStatementRestInteraction.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      resource: (json['resource'] as List<dynamic>?)?.map((e) => CapabilityStatementRestResource.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      security: json['security'] != null ? CapabilityStatementRestSecurity.fromJson(json['security'] as Map<String, dynamic>) : null,
    );
    }
