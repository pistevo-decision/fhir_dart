...
class CapabilityStatementRestSecurity extends BackboneElement implements FhirResource {
  ...
  factory CapabilityStatementRestSecurity.fromJson(Map<String, dynamic> json) {
    return CapabilityStatementRestSecurity(
      ...
      service: (json['service'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
