...
class FhirList extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'current', 'retired', 'entered-in-error'
  ...
  factory FhirList.fromJson(Map<String, dynamic> json) {
    return FhirList(
      ...
      entry: (json['entry'] as List<dynamic>?)?.map((e) => ListEntry.fromJson(e as Map<String, dynamic>)).toList(),
