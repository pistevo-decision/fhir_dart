...
class AuditEventAgent extends BackboneElement implements FhirResource {
  ...
  factory AuditEventAgent.fromJson(Map<String, dynamic> json) {
    return AuditEventAgent(
      ...
      media: json['media'] != null ? Coding.fromJson(json['media'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      name: json['name'] as String?,
      network: json['network'] != null ? AuditEventAgentNetwork.fromJson(json['network'] as Map<String, dynamic>) : null,
      policy: (json['policy'] as List<dynamic>?)?.map((e) => e as String).toList(),
      purposeOfUse: (json['purposeOfUse'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      requestor: json['requestor'] as bool,
      role: (json['role'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
