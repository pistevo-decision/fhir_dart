...
class Questionnaire extends DomainResource implements FhirResource {
  ...
  factory Questionnaire.fromJson(Map<String, dynamic> json) {
    return Questionnaire(
      ...
      derivedFrom: (json['derivedFrom'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      subjectType: (json['subjectType'] as List<dynamic>?)?.map((e) => e as String).toList(),
