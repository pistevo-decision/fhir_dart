...
class Coverage extends DomainResource implements FhirResource {
  ...
  factory Coverage.fromJson(Map<String, dynamic> json) {
    return Coverage(
      ...
      fhirClass: (json['class'] as List<dynamic>?)?.map((e) => CoverageClass.fromJson(e as Map<String, dynamic>)).toList(),
      contained: (json['contained'] as List<dynamic>?)?.map((e) => Resource.fromJson(e as Map<String, dynamic>)).toList(),
      contract: (json['contract'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      costToBeneficiary: (json['costToBeneficiary'] as List<dynamic>?)?.map((e) => CoverageCostToBeneficiary.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      payor: (json['payor'] as List<dynamic>).map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      period: json['period'] != null ? Period.fromJson(json['period'] as Map<String, dynamic>) : null,
      policyHolder: json['policyHolder'] != null ? Reference.fromJson(json['policyHolder'] as Map<String, dynamic>) : null,
      ...
      subscriber: json['subscriber'] != null ? Reference.fromJson(json['subscriber'] as Map<String, dynamic>) : null,
