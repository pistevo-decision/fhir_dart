...
class StructureDefinition extends DomainResource implements FhirResource {
  ...
  final String kind; // Possible values: 'primitive-type', 'complex-type', 'resource', 'logical'
  ...
  factory StructureDefinition.fromJson(Map<String, dynamic> json) {
    return StructureDefinition(
      ...
      context: (json['context'] as List<dynamic>?)?.map((e) => StructureDefinitionContext.fromJson(e as Map<String, dynamic>)).toList(),
      contextInvariant: (json['contextInvariant'] as List<dynamic>?)?.map((e) => e as String).toList(),
      copyright: json['copyright'] as String?,
      date: json['date'] as String?,
      derivation: json['derivation'] as String?,
      description: json['description'] as String?,
      differential: json['differential'] != null ? StructureDefinitionDifferential.fromJson(json['differential'] as Map<String, dynamic>) : null,
      ...
      keyword: (json['keyword'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
      kind: json['kind'] as String,
      language: json['language'] as String?,
      mapping: (json['mapping'] as List<dynamic>?)?.map((e) => StructureDefinitionMapping.fromJson(e as Map<String, dynamic>)).toList(),
      meta: json['meta'] != null ? Meta.fromJson(json['meta'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      name: json['name'] as String,
      publisher: json['publisher'] as String?,
      purpose: json['purpose'] as String?,
      snapshot: json['snapshot'] != null ? StructureDefinitionSnapshot.fromJson(json['snapshot'] as Map<String, dynamic>) : null,
