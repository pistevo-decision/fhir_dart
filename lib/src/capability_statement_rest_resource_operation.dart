...
class CapabilityStatementRestResourceOperation extends BackboneElement implements FhirResource {
  ...
  @override
  factory CapabilityStatementRestResourceOperation.fromJson(Map<String, dynamic> json) {
