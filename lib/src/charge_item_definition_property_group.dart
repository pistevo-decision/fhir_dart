...
class ChargeItemDefinitionPropertyGroup extends BackboneElement implements FhirResource {
  ...
  factory ChargeItemDefinitionPropertyGroup.fromJson(Map<String, dynamic> json) {
    return ChargeItemDefinitionPropertyGroup(
      ...
      priceComponent: (json['priceComponent'] as List<dynamic>?)?.map((e) => ChargeItemDefinitionPropertyGroupPriceComponent.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
