...
class TerminologyCapabilitiesCodeSystemVersion extends BackboneElement implements FhirResource {
  ...
  @override
  factory TerminologyCapabilitiesCodeSystemVersion.fromJson(Map<String, dynamic> json) {
    return TerminologyCapabilitiesCodeSystemVersion(
      code: json['code'] as String?,
      compositional: json['compositional'] as bool?,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      filter: (json['filter'] as List<dynamic>?)?.map((e) => TerminologyCapabilitiesCodeSystemVersionFilter.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      isDefault: json['isDefault'] as bool?,
      language: (json['language'] as List<dynamic>?)?.map((e) => e as String).toList(),
