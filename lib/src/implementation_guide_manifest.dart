...
class ImplementationGuideManifest extends BackboneElement implements FhirResource {
   /// Image within the IG
  ...
  factory ImplementationGuideManifest.fromJson(Map<String, dynamic> json) {
    return ImplementationGuideManifest(
      ...
      page: (json['page'] as List<dynamic>?)?.map((e) => ImplementationGuideManifestPage.fromJson(e as Map<String, dynamic>)).toList(),
      rendering: json['rendering'] as String?,
      resource: (json['resource'] as List<dynamic>).map((e) => ImplementationGuideManifestResource.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
