...
class Provenance extends DomainResource implements FhirResource {
  ...
  factory Provenance.fromJson(Map<String, dynamic> json) {
    return Provenance(
      activity: json['activity'] != null ? CodeableConcept.fromJson(json['activity'] as Map<String, dynamic>) : null,
      ...
      entity: (json['entity'] as List<dynamic>?)?.map((e) => ProvenanceEntity.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      occurredPeriod: json['occurredPeriod'] != null ? Period.fromJson(json['occurredPeriod'] as Map<String, dynamic>) : null,
