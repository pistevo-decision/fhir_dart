...
class ClaimResponseAddItemDetail extends BackboneElement implements FhirResource {
  ...
  final List<ClaimResponseAddItemDetailSubDetail>? subDetail;
  ...
  factory ClaimResponseAddItemDetail.fromJson(Map<String, dynamic> json) {
    return ClaimResponseAddItemDetail(
      ...
      subDetail: (json['subDetail'] as List<dynamic>?)?.map((e) => ClaimResponseAddItemDetailSubDetail.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  @override
  ClaimResponseAddItemDetail copyWith({
    ...
    Quantity? quantity,
    List<ClaimResponseAddItemDetailSubDetail>? subDetail,
    Money? unitPrice,
  }) {
    return ClaimResponseAddItemDetail(
