...
class OperationDefinition extends DomainResource implements FhirResource {
  ...
  factory OperationDefinition.fromJson(Map<String, dynamic> json) {
    return OperationDefinition(
      ...
      overload: (json['overload'] as List<dynamic>?)?.map((e) => OperationDefinitionOverload.fromJson(e as Map<String, dynamic>)).toList(),
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => OperationDefinitionParameter.fromJson(e as Map<String, dynamic>)).toList(),
      publisher: json['publisher'] as String?,
      purpose: json['purpose'] as String?,
      resource: (json['resource'] as List<dynamic>?)?.map((e) => e as String).toList(),
