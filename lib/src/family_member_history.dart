...
class FamilyMemberHistory extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'partial', 'completed', 'entered-in-error', 'health-unknown'
  FamilyMemberHistory({
    this.ageAge,
    this.ageRange,
    this.ageString,
  ...
  factory FamilyMemberHistory.fromJson(Map<String, dynamic> json) {
    return FamilyMemberHistory(
      ageAge: json['ageAge'] != null ? Age.fromJson(json['ageAge'] as Map<String, dynamic>) : null,
      ...
      bornPeriod: json['bornPeriod'] != null ? Period.fromJson(json['bornPeriod'] as Map<String, dynamic>) : null,
      bornString: json['bornString'] as String?,
      condition: (json['condition'] as List<dynamic>?)?.map((e) => FamilyMemberHistoryCondition.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      deceasedAge: json['deceasedAge'] != null ? Age.fromJson(json['deceasedAge'] as Map<String, dynamic>) : null,
      deceasedBoolean: json['deceasedBoolean'] as bool?,
      deceasedDate: json['deceasedDate'] as String?,
      deceasedRange: json['deceasedRange'] != null ? Range.fromJson(json['deceasedRange'] as Map<String, dynamic>) : null,
      ...
      relationship: CodeableConcept.fromJson(json['relationship'] as Map<String, dynamic>),
      sex: json['sex'] != null ? CodeableConcept.fromJson(json['sex'] as Map<String, dynamic>) : null,
