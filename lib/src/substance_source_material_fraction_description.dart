...
class SubstanceSourceMaterialFractionDescription extends BackboneElement implements FhirResource {
  ...
  factory SubstanceSourceMaterialFractionDescription.fromJson(Map<String, dynamic> json) {
    return SubstanceSourceMaterialFractionDescription(
      ...
      materialType: json['materialType'] != null ? CodeableConcept.fromJson(json['materialType'] as Map<String, dynamic>) : null,
