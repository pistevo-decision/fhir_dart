...
class InsurancePlanPlanGeneralCost extends BackboneElement implements FhirResource {
  ...
  factory InsurancePlanPlanGeneralCost.fromJson(Map<String, dynamic> json) {
    return InsurancePlanPlanGeneralCost(
      ...
      cost: json['cost'] != null ? Money.fromJson(json['cost'] as Map<String, dynamic>) : null,
