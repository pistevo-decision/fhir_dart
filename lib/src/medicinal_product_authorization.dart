...
class MedicinalProductAuthorization extends DomainResource implements FhirResource {
  ...
  final List<MedicinalProductAuthorizationJurisdictionalAuthorization>? jurisdictionalAuthorization;
  ...
  factory MedicinalProductAuthorization.fromJson(Map<String, dynamic> json) {
    return MedicinalProductAuthorization(
      ...
      dataExclusivityPeriod: json['dataExclusivityPeriod'] != null ? Period.fromJson(json['dataExclusivityPeriod'] as Map<String, dynamic>) : null,
      dateOfFirstAuthorization: json['dateOfFirstAuthorization'] as String?,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      holder: json['holder'] != null ? Reference.fromJson(json['holder'] as Map<String, dynamic>) : null,
      ...
      jurisdictionalAuthorization: (json['jurisdictionalAuthorization'] as List<dynamic>?)?.map((e) => MedicinalProductAuthorizationJurisdictionalAuthorization.fromJson(e as Map<String, dynamic>)).toList(),
      language: json['language'] as String?,
      legalBasis: json['legalBasis'] != null ? CodeableConcept.fromJson(json['legalBasis'] as Map<String, dynamic>) : null,
      meta: json['meta'] != null ? Meta.fromJson(json['meta'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      procedure: json['procedure'] != null ? MedicinalProductAuthorizationProcedure.fromJson(json['procedure'] as Map<String, dynamic>) : null,
      regulator: json['regulator'] != null ? Reference.fromJson(json['regulator'] as Map<String, dynamic>) : null,
      ...
      validityPeriod: json['validityPeriod'] != null ? Period.fromJson(json['validityPeriod'] as Map<String, dynamic>) : null,
    );
    }
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'jurisdictionalAuthorization': jurisdictionalAuthorization?.map((e) => e.toJson()).toList(),
      'language': language,
  ...
  MedicinalProductAuthorization copyWith({
    ...
    return MedicinalProductAuthorization(
      ...
      dataExclusivityPeriod: dataExclusivityPeriod ?? this.dataExclusivityPeriod,
      dateOfFirstAuthorization: dateOfFirstAuthorization ?? this.dateOfFirstAuthorization,
      fhirExtension: fhirExtension ?? this.fhirExtension,
      holder: holder ?? this.holder,
      id: id ?? this.id,
      identifier: identifier ?? this.identifier,
      implicitRules: implicitRules ?? this.implicitRules,
      internationalBirthDate: internationalBirthDate ?? this.internationalBirthDate,
      jurisdiction: jurisdiction ?? this.jurisdiction,
      jurisdictionalAuthorization: jurisdictionalAuthorization ?? this.jurisdictionalAuthorization,
