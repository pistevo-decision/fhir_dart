...
class ContractTermAction extends BackboneElement implements FhirResource {
  ...
  factory ContractTermAction.fromJson(Map<String, dynamic> json) {
    return ContractTermAction(
      ...
      contextLinkId: (json['contextLinkId'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      performerLinkId: (json['performerLinkId'] as List<dynamic>?)?.map((e) => e as String).toList(),
      performerRole: json['performerRole'] != null ? CodeableConcept.fromJson(json['performerRole'] as Map<String, dynamic>) : null,
      ...
      reasonLinkId: (json['reasonLinkId'] as List<dynamic>?)?.map((e) => e as String).toList(),
      reasonReference: (json['reasonReference'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      requester: (json['requester'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      requesterLinkId: (json['requesterLinkId'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      subject: (json['subject'] as List<dynamic>?)?.map((e) => ContractTermActionSubject.fromJson(e as Map<String, dynamic>)).toList(),
