...
class ChargeItemDefinition extends DomainResource implements FhirResource {
  ...
  factory ChargeItemDefinition.fromJson(Map<String, dynamic> json) {
    return ChargeItemDefinition(
      applicability: (json['applicability'] as List<dynamic>?)?.map((e) => ChargeItemDefinitionApplicability.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      derivedFromUri: (json['derivedFromUri'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      instance: (json['instance'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      partOf: (json['partOf'] as List<dynamic>?)?.map((e) => e as String).toList(),
      propertyGroup: (json['propertyGroup'] as List<dynamic>?)?.map((e) => ChargeItemDefinitionPropertyGroup.fromJson(e as Map<String, dynamic>)).toList(),
