...
class DosageDoseAndRate extends Element implements FhirResource {
  ...
  factory DosageDoseAndRate.fromJson(Map<String, dynamic> json) {
    return DosageDoseAndRate(
      ...
      doseRange: json['doseRange'] != null ? Range.fromJson(json['doseRange'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      rateQuantity: json['rateQuantity'] != null ? Quantity.fromJson(json['rateQuantity'] as Map<String, dynamic>) : null,
      rateRange: json['rateRange'] != null ? Range.fromJson(json['rateRange'] as Map<String, dynamic>) : null,
      rateRatio: json['rateRatio'] != null ? Ratio.fromJson(json['rateRatio'] as Map<String, dynamic>) : null,
