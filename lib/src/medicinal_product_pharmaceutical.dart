...
class MedicinalProductPharmaceutical extends DomainResource implements FhirResource {
  ...
  final List<MedicinalProductPharmaceuticalRouteOfAdministration> routeOfAdministration;
   /// Todo.
  ...
  factory MedicinalProductPharmaceutical.fromJson(Map<String, dynamic> json) {
    return MedicinalProductPharmaceutical(
      administrableDoseForm: CodeableConcept.fromJson(json['administrableDoseForm'] as Map<String, dynamic>),
      characteristics: (json['characteristics'] as List<dynamic>?)?.map((e) => MedicinalProductPharmaceuticalCharacteristics.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      routeOfAdministration: (json['routeOfAdministration'] as List<dynamic>).map((e) => MedicinalProductPharmaceuticalRouteOfAdministration.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'routeOfAdministration': routeOfAdministration.map((e) => e.toJson()).toList(),
      'text': text?.toJson(),
  ...
  MedicinalProductPharmaceutical copyWith({
    ...
    return MedicinalProductPharmaceutical(
      administrableDoseForm: administrableDoseForm ?? this.administrableDoseForm,
