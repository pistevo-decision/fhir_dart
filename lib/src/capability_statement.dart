...
class CapabilityStatement extends DomainResource implements FhirResource {
  ...
  final String fhirVersion; // Possible values: '0.01', '0.05', '0.06', '0.11', '0.0.80', '0.0.81', '0.0.82', '0.4.0', '0.5.0', '1.0.0', '1.0.1', '1.0.2', '1.1.0', '1.4.0', '1.6.0', '1.8.0', '3.0.0', '3.0.1', '3.3.0', '3.5.0', '4.0.0', '4.0.1'
  ...
  final String kind; // Possible values: 'instance', 'capability', 'requirements'
  ...
  factory CapabilityStatement.fromJson(Map<String, dynamic> json) {
    return CapabilityStatement(
      ...
      document: (json['document'] as List<dynamic>?)?.map((e) => CapabilityStatementDocument.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      implementation: json['implementation'] != null ? CapabilityStatementImplementation.fromJson(json['implementation'] as Map<String, dynamic>) : null,
      implementationGuide: (json['implementationGuide'] as List<dynamic>?)?.map((e) => e as String).toList(),
      implicitRules: json['implicitRules'] as String?,
      imports: (json['imports'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      messaging: (json['messaging'] as List<dynamic>?)?.map((e) => CapabilityStatementMessaging.fromJson(e as Map<String, dynamic>)).toList(),
      meta: json['meta'] != null ? Meta.fromJson(json['meta'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      name: json['name'] as String?,
      patchFormat: (json['patchFormat'] as List<dynamic>?)?.map((e) => e as String).toList(),
      publisher: json['publisher'] as String?,
      purpose: json['purpose'] as String?,
      rest: (json['rest'] as List<dynamic>?)?.map((e) => CapabilityStatementRest.fromJson(e as Map<String, dynamic>)).toList(),
      software: json['software'] != null ? CapabilityStatementSoftware.fromJson(json['software'] as Map<String, dynamic>) : null,
