...
class CapabilityStatementRestResource extends BackboneElement implements FhirResource {
  ...
  final String? conditionalDelete; // Possible values: 'not-supported', 'single', 'multiple'
   /// A code that indicates how the server supports conditional read.
   /// Conditional Read is mainly appropriate for interface engine scripts converting from other formats, such as v2.
  final String? conditionalRead; // Possible values: 'not-supported', 'modified-since', 'not-match', 'full-support'
  ...
  final List<String>? referencePolicy; // Possible values: 'literal', 'logical', 'resolves', 'enforced', 'local'
  ...
  final String? versioning; // Possible values: 'no-version', 'versioned', 'versioned-update'
  ...
  factory CapabilityStatementRestResource.fromJson(Map<String, dynamic> json) {
    return CapabilityStatementRestResource(
      ...
      interaction: (json['interaction'] as List<dynamic>?)?.map((e) => CapabilityStatementRestResourceInteraction.fromJson(e as Map<String, dynamic>)).toList(),
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      operation: (json['operation'] as List<dynamic>?)?.map((e) => CapabilityStatementRestResourceOperation.fromJson(e as Map<String, dynamic>)).toList(),
      profile: json['profile'] as String?,
      readHistory: json['readHistory'] as bool?,
      referencePolicy: (json['referencePolicy'] as List<dynamic>?)?.map((e) => e as String).toList(),
      searchInclude: (json['searchInclude'] as List<dynamic>?)?.map((e) => e as String).toList(),
      searchParam: (json['searchParam'] as List<dynamic>?)?.map((e) => CapabilityStatementRestResourceSearchParam.fromJson(e as Map<String, dynamic>)).toList(),
      searchRevInclude: (json['searchRevInclude'] as List<dynamic>?)?.map((e) => e as String).toList(),
      supportedProfile: (json['supportedProfile'] as List<dynamic>?)?.map((e) => e as String).toList(),
