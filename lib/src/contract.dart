...
class Contract extends DomainResource implements FhirResource {
  ...
  final String?
      status; // Possible values: 'amended', 'appended', 'cancelled', 'disputed', 'entered-in-error', 'executable', 'executed', 'negotiable', 'offered', 'policy', 'rejected', 'renewed', 'revoked', 'resolved', 'terminated'
