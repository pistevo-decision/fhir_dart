...
class VisionPrescriptionLensSpecification extends BackboneElement implements FhirResource {
  ...
  factory VisionPrescriptionLensSpecification.fromJson(Map<String, dynamic> json) {
    return VisionPrescriptionLensSpecification(
      ...
      prism: (json['prism'] as List<dynamic>?)?.map((e) => VisionPrescriptionLensSpecificationPrism.fromJson(e as Map<String, dynamic>)).toList(),
