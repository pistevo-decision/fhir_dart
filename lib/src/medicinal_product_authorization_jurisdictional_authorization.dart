...
class MedicinalProductAuthorizationJurisdictionalAuthorization extends BackboneElement implements FhirResource {
  ...
  factory MedicinalProductAuthorizationJurisdictionalAuthorization.fromJson(Map<String, dynamic> json) {
    return MedicinalProductAuthorizationJurisdictionalAuthorization(
      country: json['country'] != null ? CodeableConcept.fromJson(json['country'] as Map<String, dynamic>) : null,
