...
class CompositionSection extends BackboneElement implements FhirResource {
  ...
  factory CompositionSection.fromJson(Map<String, dynamic> json) {
    return CompositionSection(
      ...
      emptyReason: json['emptyReason'] != null ? CodeableConcept.fromJson(json['emptyReason'] as Map<String, dynamic>) : null,
      entry: (json['entry'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      orderedBy: json['orderedBy'] != null ? CodeableConcept.fromJson(json['orderedBy'] as Map<String, dynamic>) : null,
