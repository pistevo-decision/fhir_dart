...
class SubstanceSpecificationRelationship extends BackboneElement implements FhirResource {
  ...
  factory SubstanceSpecificationRelationship.fromJson(Map<String, dynamic> json) {
    return SubstanceSpecificationRelationship(
      ...
      amountRatio: json['amountRatio'] != null ? Ratio.fromJson(json['amountRatio'] as Map<String, dynamic>) : null,
      amountString: json['amountString'] as String?,
      amountRatioLowLimit: json['amountRatioLowLimit'] != null ? Ratio.fromJson(json['amountRatioLowLimit'] as Map<String, dynamic>) : null,
      ...
      substanceCodeableConcept: json['substanceCodeableConcept'] != null ? CodeableConcept.fromJson(json['substanceCodeableConcept'] as Map<String, dynamic>) : null,
      substanceReference: json['substanceReference'] != null ? Reference.fromJson(json['substanceReference'] as Map<String, dynamic>) : null,
    );
    }
  ...
  SubstanceSpecificationRelationship copyWith({
    ...
    return SubstanceSpecificationRelationship(
      ...
      substanceCodeableConcept: substanceCodeableConcept ?? this.substanceCodeableConcept,
