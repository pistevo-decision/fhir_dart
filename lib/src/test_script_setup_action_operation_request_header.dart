...
class TestScriptSetupActionOperationRequestHeader extends BackboneElement implements FhirResource {
  ...
  @override
  factory TestScriptSetupActionOperationRequestHeader.fromJson(Map<String, dynamic> json) {
