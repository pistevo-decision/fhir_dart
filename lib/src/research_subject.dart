...
class ResearchSubject extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'candidate', 'eligible', 'follow-up', 'ineligible', 'not-registered', 'off-study', 'on-study', 'on-study-intervention', 'on-study-observation', 'pending-on-study', 'potential-candidate', 'screening', 'withdrawn'
  ...
  factory ResearchSubject.fromJson(Map<String, dynamic> json) {
    return ResearchSubject(
      ...
      consent: json['consent'] != null ? Reference.fromJson(json['consent'] as Map<String, dynamic>) : null,
