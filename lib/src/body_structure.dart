...
class BodyStructure extends DomainResource implements FhirResource {
  ...
  factory BodyStructure.fromJson(Map<String, dynamic> json) {
    return BodyStructure(
      ...
      location: json['location'] != null ? CodeableConcept.fromJson(json['location'] as Map<String, dynamic>) : null,
      locationQualifier: (json['locationQualifier'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      meta: json['meta'] != null ? Meta.fromJson(json['meta'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      morphology: json['morphology'] != null ? CodeableConcept.fromJson(json['morphology'] as Map<String, dynamic>) : null,
