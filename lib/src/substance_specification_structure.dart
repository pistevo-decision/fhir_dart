...
class SubstanceSpecificationStructure extends BackboneElement implements FhirResource {
  ...
  factory SubstanceSpecificationStructure.fromJson(Map<String, dynamic> json) {
    return SubstanceSpecificationStructure(
      ...
      isotope: (json['isotope'] as List<dynamic>?)?.map((e) => SubstanceSpecificationStructureIsotope.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      representation: (json['representation'] as List<dynamic>?)?.map((e) => SubstanceSpecificationStructureRepresentation.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  SubstanceSpecificationStructure copyWith({
    ...
    return SubstanceSpecificationStructure(
      ...
      molecularFormulaByMoiety: molecularFormulaByMoiety ?? this.molecularFormulaByMoiety,
