...
class MedicinalProductManufacturingBusinessOperation extends BackboneElement implements FhirResource {
  ...
  factory MedicinalProductManufacturingBusinessOperation.fromJson(Map<String, dynamic> json) {
    return MedicinalProductManufacturingBusinessOperation(
      authorisationReferenceNumber: json['authorisationReferenceNumber'] != null ? Identifier.fromJson(json['authorisationReferenceNumber'] as Map<String, dynamic>) : null,
      confidentialityIndicator: json['confidentialityIndicator'] != null ? CodeableConcept.fromJson(json['confidentialityIndicator'] as Map<String, dynamic>) : null,
      ...
      operationType: json['operationType'] != null ? CodeableConcept.fromJson(json['operationType'] as Map<String, dynamic>) : null,
  ...
  MedicinalProductManufacturingBusinessOperation copyWith({
    ...
    return MedicinalProductManufacturingBusinessOperation(
      authorisationReferenceNumber: authorisationReferenceNumber ?? this.authorisationReferenceNumber,
      confidentialityIndicator: confidentialityIndicator ?? this.confidentialityIndicator,
