...
class ConsentProvision extends BackboneElement implements FhirResource {
  ...
  factory ConsentProvision.fromJson(Map<String, dynamic> json) {
    return ConsentProvision(
      action: (json['action'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      actor: (json['actor'] as List<dynamic>?)?.map((e) => ConsentProvisionActor.fromJson(e as Map<String, dynamic>)).toList(),
      fhirClass: (json['class'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
      code: (json['code'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      data: (json['data'] as List<dynamic>?)?.map((e) => ConsentProvisionData.fromJson(e as Map<String, dynamic>)).toList(),
      dataPeriod: json['dataPeriod'] != null ? Period.fromJson(json['dataPeriod'] as Map<String, dynamic>) : null,
      ...
      provision: (json['provision'] as List<dynamic>?)?.map((e) => ConsentProvision.fromJson(e as Map<String, dynamic>)).toList(),
      purpose: (json['purpose'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
      securityLabel: (json['securityLabel'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
