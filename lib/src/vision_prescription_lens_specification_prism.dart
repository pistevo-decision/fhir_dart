...
class VisionPrescriptionLensSpecificationPrism extends BackboneElement implements FhirResource {
  ...
  @override
  factory VisionPrescriptionLensSpecificationPrism.fromJson(Map<String, dynamic> json) {
