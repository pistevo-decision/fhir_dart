...
class NutritionOrderOralDiet extends BackboneElement implements FhirResource {
  ...
  factory NutritionOrderOralDiet.fromJson(Map<String, dynamic> json) {
    return NutritionOrderOralDiet(
      ...
      fluidConsistencyType: (json['fluidConsistencyType'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      instruction: json['instruction'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      nutrient: (json['nutrient'] as List<dynamic>?)?.map((e) => NutritionOrderOralDietNutrient.fromJson(e as Map<String, dynamic>)).toList(),
      schedule: (json['schedule'] as List<dynamic>?)?.map((e) => Timing.fromJson(e as Map<String, dynamic>)).toList(),
      texture: (json['texture'] as List<dynamic>?)?.map((e) => NutritionOrderOralDietTexture.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'fluidConsistencyType': fluidConsistencyType?.map((e) => e.toJson()).toList(),
      'id': id,
