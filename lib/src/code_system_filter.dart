...
class CodeSystemFilter extends BackboneElement implements FhirResource {
  ...
  final List<String> fhirOperator; // Possible values: '=', 'is-a', 'descendent-of', 'is-not-a', 'regex', 'in', 'not-in', 'generalizes', 'exists'
  ...
  factory CodeSystemFilter.fromJson(Map<String, dynamic> json) {
    return CodeSystemFilter(
      ...
      fhirOperator: (json['operator'] as List<dynamic>).map((e) => e as String).toList(),
