...
class InsurancePlan extends DomainResource implements FhirResource {
  ...
  factory InsurancePlan.fromJson(Map<String, dynamic> json) {
    return InsurancePlan(
      administeredBy: json['administeredBy'] != null ? Reference.fromJson(json['administeredBy'] as Map<String, dynamic>) : null,
      alias: (json['alias'] as List<dynamic>?)?.map((e) => e as String).toList(),
      contact: (json['contact'] as List<dynamic>?)?.map((e) => InsurancePlanContact.fromJson(e as Map<String, dynamic>)).toList(),
      contained: (json['contained'] as List<dynamic>?)?.map((e) => Resource.fromJson(e as Map<String, dynamic>)).toList(),
      coverage: (json['coverage'] as List<dynamic>?)?.map((e) => InsurancePlanCoverage.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      ownedBy: json['ownedBy'] != null ? Reference.fromJson(json['ownedBy'] as Map<String, dynamic>) : null,
      period: json['period'] != null ? Period.fromJson(json['period'] as Map<String, dynamic>) : null,
      plan: (json['plan'] as List<dynamic>?)?.map((e) => InsurancePlanPlan.fromJson(e as Map<String, dynamic>)).toList(),
