...
class MolecularSequenceRepository extends BackboneElement implements FhirResource {
  ...
  final String type; // Possible values: 'directlink', 'openapi', 'login', 'oauth', 'other'
