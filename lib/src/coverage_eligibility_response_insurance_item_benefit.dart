...
class CoverageEligibilityResponseInsuranceItemBenefit extends BackboneElement implements FhirResource {
   /// Benefits allowed
  ...
  @override
  factory CoverageEligibilityResponseInsuranceItemBenefit.fromJson(Map<String, dynamic> json) {
