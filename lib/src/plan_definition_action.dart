...
class PlanDefinitionAction extends BackboneElement implements FhirResource {
  ...
  final String? groupingBehavior; // Possible values: 'visual-group', 'logical-group', 'sentence-group'
  ...
  final String? requiredBehavior; // Possible values: 'must', 'could', 'must-unless-documented'
   /// Defines the selection behavior for the action and its children.
  final String? selectionBehavior; // Possible values: 'any', 'all', 'all-or-none', 'exactly-one', 'at-most-one', 'one-or-more'
  ...
  factory PlanDefinitionAction.fromJson(Map<String, dynamic> json) {
    return PlanDefinitionAction(
      action: (json['action'] as List<dynamic>?)?.map((e) => PlanDefinitionAction.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      condition: (json['condition'] as List<dynamic>?)?.map((e) => PlanDefinitionActionCondition.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      dynamicValue: (json['dynamicValue'] as List<dynamic>?)?.map((e) => PlanDefinitionActionDynamicValue.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      goalId: (json['goalId'] as List<dynamic>?)?.map((e) => e as String).toList(),
      groupingBehavior: json['groupingBehavior'] as String?,
      id: json['id'] as String?,
      input: (json['input'] as List<dynamic>?)?.map((e) => DataRequirement.fromJson(e as Map<String, dynamic>)).toList(),
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      output: (json['output'] as List<dynamic>?)?.map((e) => DataRequirement.fromJson(e as Map<String, dynamic>)).toList(),
      participant: (json['participant'] as List<dynamic>?)?.map((e) => PlanDefinitionActionParticipant.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      relatedAction: (json['relatedAction'] as List<dynamic>?)?.map((e) => PlanDefinitionActionRelatedAction.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      trigger: (json['trigger'] as List<dynamic>?)?.map((e) => TriggerDefinition.fromJson(e as Map<String, dynamic>)).toList(),
