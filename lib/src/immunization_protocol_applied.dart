...
class ImmunizationProtocolApplied extends BackboneElement implements FhirResource {
  ...
  factory ImmunizationProtocolApplied.fromJson(Map<String, dynamic> json) {
    return ImmunizationProtocolApplied(
      ...
      targetDisease: (json['targetDisease'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
