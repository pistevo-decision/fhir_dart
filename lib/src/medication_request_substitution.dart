...
class MedicationRequestSubstitution extends BackboneElement implements FhirResource {
  ...
  factory MedicationRequestSubstitution.fromJson(Map<String, dynamic> json) {
    return MedicationRequestSubstitution(
      ...
      allowedCodeableConcept: json['allowedCodeableConcept'] != null ? CodeableConcept.fromJson(json['allowedCodeableConcept'] as Map<String, dynamic>) : null,
  ...
  MedicationRequestSubstitution copyWith({
    ...
    return MedicationRequestSubstitution(
      ...
      allowedCodeableConcept: allowedCodeableConcept ?? this.allowedCodeableConcept,
