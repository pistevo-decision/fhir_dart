...
class EffectEvidenceSynthesis extends DomainResource implements FhirResource {
  ...
  static const fhirResourceType = 'EffectEvidenceSynthesis';
  ...
  factory EffectEvidenceSynthesis.fromJson(Map<String, dynamic> json) {
    return EffectEvidenceSynthesis(
      ...
      endorser: (json['endorser'] as List<dynamic>?)
          ...
          .toList(),
      exposure:
          Reference.fromJson((json['exposure'] as Map).cast<String, dynamic>()),
      exposureAlternative: Reference.fromJson(
          (json['exposureAlternative'] as Map).cast<String, dynamic>()),
      ...
      note: (json['note'] as List<dynamic>?)
          ...
          .toList(),
      outcome:
          Reference.fromJson((json['outcome'] as Map).cast<String, dynamic>()),
      population: Reference.fromJson(
          (json['population'] as Map).cast<String, dynamic>()),
      ...
      sampleSize: json['sampleSize'] != null
          ? EffectEvidenceSynthesisSampleSize.fromJson(
              (json['sampleSize'] as Map).cast<String, dynamic>())
          : null,
      status: json['status'] as String,
      studyType: json['studyType'] != null
          ? CodeableConcept.fromJson(
              (json['studyType'] as Map).cast<String, dynamic>())
          : null,
      synthesisType: json['synthesisType'] != null
          ? CodeableConcept.fromJson(
              (json['synthesisType'] as Map).cast<String, dynamic>())
          : null,
      text: json['text'] != null
