...
class BundleEntry extends BackboneElement implements FhirResource {
  ...
  factory BundleEntry.fromJson(Map<String, dynamic> json) {
    return BundleEntry(
      ...
      link: (json['link'] as List<dynamic>?)?.map((e) => BundleLink.fromJson(e as Map<String, dynamic>)).toList(),
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      request: json['request'] != null ? BundleEntryRequest.fromJson(json['request'] as Map<String, dynamic>) : null,
      resource: json['resource'] != null ? FhirResource.fromJson(json['resource'] as Map<String, dynamic>) : null,
      response: json['response'] != null ? BundleEntryResponse.fromJson(json['response'] as Map<String, dynamic>) : null,
      search: json['search'] != null ? BundleEntrySearch.fromJson(json['search'] as Map<String, dynamic>) : null,
    );
    }
