...
class CoverageEligibilityRequest extends DomainResource implements FhirResource {
  ...
  final List<String> purpose; // Possible values: 'auth-requirements', 'benefits', 'discovery', 'validation'
  ...
  factory CoverageEligibilityRequest.fromJson(Map<String, dynamic> json) {
    return CoverageEligibilityRequest(
      ...
      insurance: (json['insurance'] as List<dynamic>?)?.map((e) => CoverageEligibilityRequestInsurance.fromJson(e as Map<String, dynamic>)).toList(),
      insurer: Reference.fromJson(json['insurer'] as Map<String, dynamic>),
      item: (json['item'] as List<dynamic>?)?.map((e) => CoverageEligibilityRequestItem.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      supportingInfo: (json['supportingInfo'] as List<dynamic>?)?.map((e) => CoverageEligibilityRequestSupportingInfo.fromJson(e as Map<String, dynamic>)).toList(),
