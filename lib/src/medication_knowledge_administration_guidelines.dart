...
class MedicationKnowledgeAdministrationGuidelines extends BackboneElement implements FhirResource {
  ...
  final List<MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics>? patientCharacteristics;
  ...
  factory MedicationKnowledgeAdministrationGuidelines.fromJson(Map<String, dynamic> json) {
    return MedicationKnowledgeAdministrationGuidelines(
      dosage: (json['dosage'] as List<dynamic>?)?.map((e) => MedicationKnowledgeAdministrationGuidelinesDosage.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      patientCharacteristics: (json['patientCharacteristics'] as List<dynamic>?)?.map((e) => MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'patientCharacteristics': patientCharacteristics?.map((e) => e.toJson()).toList(),
    };
  ...
  MedicationKnowledgeAdministrationGuidelines copyWith({
    ...
    List<MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics>? patientCharacteristics,
  }) {
    return MedicationKnowledgeAdministrationGuidelines(
      ...
      patientCharacteristics: patientCharacteristics ?? this.patientCharacteristics,
    );
  }
}
