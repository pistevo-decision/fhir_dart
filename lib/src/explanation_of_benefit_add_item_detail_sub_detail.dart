...
class ExplanationOfBenefitAddItemDetailSubDetail extends BackboneElement implements FhirResource {
  ...
  @override
  factory ExplanationOfBenefitAddItemDetailSubDetail.fromJson(Map<String, dynamic> json) {
  ...
  @override
  ExplanationOfBenefitAddItemDetailSubDetail copyWith({
