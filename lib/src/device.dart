...
class Device extends DomainResource implements FhirResource {
  ...
  final String? status; // Possible values: 'active', 'inactive', 'entered-in-error', 'unknown'
  ...
  factory Device.fromJson(Map<String, dynamic> json) {
    return Device(
      ...
      definition: json['definition'] != null ? Reference.fromJson(json['definition'] as Map<String, dynamic>) : null,
      deviceName: (json['deviceName'] as List<dynamic>?)?.map((e) => DeviceDeviceName.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      property: (json['property'] as List<dynamic>?)?.map((e) => DeviceProperty.fromJson(e as Map<String, dynamic>)).toList(),
      safety: (json['safety'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      serialNumber: json['serialNumber'] as String?,
      specialization: (json['specialization'] as List<dynamic>?)?.map((e) => DeviceSpecialization.fromJson(e as Map<String, dynamic>)).toList(),
      status: json['status'] as String?,
      statusReason: (json['statusReason'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      udiCarrier: (json['udiCarrier'] as List<dynamic>?)?.map((e) => DeviceUdiCarrier.fromJson(e as Map<String, dynamic>)).toList(),
      url: json['url'] as String?,
      version: (json['version'] as List<dynamic>?)?.map((e) => DeviceVersion.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
