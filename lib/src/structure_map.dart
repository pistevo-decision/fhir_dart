...
class StructureMap extends DomainResource implements FhirResource {
  ...
  factory StructureMap.fromJson(Map<String, dynamic> json) {
    return StructureMap(
      ...
      group: (json['group'] as List<dynamic>).map((e) => StructureMapGroup.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      identifier: (json['identifier'] as List<dynamic>?)?.map((e) => Identifier.fromJson(e as Map<String, dynamic>)).toList(),
      implicitRules: json['implicitRules'] as String?,
      fhirImport: (json['import'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      structure: (json['structure'] as List<dynamic>?)?.map((e) => StructureMapStructure.fromJson(e as Map<String, dynamic>)).toList(),
