...
class RelatedArtifact extends Element implements FhirResource {
  ...
  final String type; // Possible values: 'documentation', 'justification', 'citation', 'predecessor', 'successor', 'derived-from', 'depends-on', 'composed-of'
  ...
  factory RelatedArtifact.fromJson(Map<String, dynamic> json) {
    return RelatedArtifact(
      ...
      document: json['document'] != null ? Attachment.fromJson(json['document'] as Map<String, dynamic>) : null,
