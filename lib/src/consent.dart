...
class Consent extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'draft', 'proposed', 'active', 'rejected', 'inactive', 'entered-in-error'
  ...
  factory Consent.fromJson(Map<String, dynamic> json) {
    return Consent(
      ...
      organization: (json['organization'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      policy: (json['policy'] as List<dynamic>?)?.map((e) => ConsentPolicy.fromJson(e as Map<String, dynamic>)).toList(),
      policyRule: json['policyRule'] != null ? CodeableConcept.fromJson(json['policyRule'] as Map<String, dynamic>) : null,
      provision: json['provision'] != null ? ConsentProvision.fromJson(json['provision'] as Map<String, dynamic>) : null,
      scope: CodeableConcept.fromJson(json['scope'] as Map<String, dynamic>),
      sourceAttachment: json['sourceAttachment'] != null ? Attachment.fromJson(json['sourceAttachment'] as Map<String, dynamic>) : null,
      sourceReference: json['sourceReference'] != null ? Reference.fromJson(json['sourceReference'] as Map<String, dynamic>) : null,
      status: json['status'] as String,
      text: json['text'] != null ? Narrative.fromJson(json['text'] as Map<String, dynamic>) : null,
      verification: (json['verification'] as List<dynamic>?)?.map((e) => ConsentVerification.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
