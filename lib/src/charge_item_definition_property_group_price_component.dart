...
class ChargeItemDefinitionPropertyGroupPriceComponent extends BackboneElement implements FhirResource {
  ...
  final String type; // Possible values: 'base', 'surcharge', 'deduction', 'discount', 'tax', 'informational'
  ...
  @override
  factory ChargeItemDefinitionPropertyGroupPriceComponent.fromJson(Map<String, dynamic> json) {
