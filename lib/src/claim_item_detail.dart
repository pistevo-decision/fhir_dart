...
class ClaimItemDetail extends BackboneElement implements FhirResource {
  ...
  factory ClaimItemDetail.fromJson(Map<String, dynamic> json) {
    return ClaimItemDetail(
      ...
      subDetail: (json['subDetail'] as List<dynamic>?)?.map((e) => ClaimItemDetailSubDetail.fromJson(e as Map<String, dynamic>)).toList(),
