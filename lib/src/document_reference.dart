...
class DocumentReference extends DomainResource implements FhirResource {
  ...
  final String?
      docStatus; // Possible values: 'preliminary', 'final', 'amended', 'entered-in-error'
  ...
  factory DocumentReference.fromJson(Map<String, dynamic> json) {
    return DocumentReference(
      authenticator: json['authenticator'] != null
          ? Reference.fromJson(
              (json['authenticator'] as Map).cast<String, dynamic>())
          : null,
      ...
      content: (json['content'] as List<dynamic>)
          .map((e) => DocumentReferenceContent.fromJson(
      ...
      masterIdentifier: json['masterIdentifier'] != null
          ? Identifier.fromJson(
              (json['masterIdentifier'] as Map).cast<String, dynamic>())
          : null,
      meta: json['meta'] != null
      ...
      relatesTo: (json['relatesTo'] as List<dynamic>?)
          ?.map((e) => DocumentReferenceRelatesTo.fromJson(
              (e as Map).cast<String, dynamic>()))
          .toList(),
