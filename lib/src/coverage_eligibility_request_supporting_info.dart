...
class CoverageEligibilityRequestSupportingInfo extends BackboneElement implements FhirResource {
  ...
  factory CoverageEligibilityRequestSupportingInfo.fromJson(Map<String, dynamic> json) {
    return CoverageEligibilityRequestSupportingInfo(
      ...
      information: Reference.fromJson(json['information'] as Map<String, dynamic>),
