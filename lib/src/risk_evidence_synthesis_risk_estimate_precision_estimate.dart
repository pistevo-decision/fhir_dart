...
class RiskEvidenceSynthesisRiskEstimatePrecisionEstimate extends BackboneElement implements FhirResource {
  ...
  @override
  factory RiskEvidenceSynthesisRiskEstimatePrecisionEstimate.fromJson(Map<String, dynamic> json) {
