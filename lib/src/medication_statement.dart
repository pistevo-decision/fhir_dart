...
class MedicationStatement extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'active', 'completed', 'entered-in-error', 'intended', 'stopped', 'on-hold', 'unknown', 'not-taken'
  ...
  factory MedicationStatement.fromJson(Map<String, dynamic> json) {
    return MedicationStatement(
      ...
      informationSource: json['informationSource'] != null ? Reference.fromJson(json['informationSource'] as Map<String, dynamic>) : null,
