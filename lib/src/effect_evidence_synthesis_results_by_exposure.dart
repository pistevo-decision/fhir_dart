...
class EffectEvidenceSynthesisResultsByExposure extends BackboneElement implements FhirResource {
   /// Description of results by exposure
   /// Human-readable summary of results by exposure state.
  final String? description;
   /// exposure | exposure-alternative
   /// Whether these results are for the exposure state or alternative exposure state.
  final String? exposureState; // Possible values: 'exposure', 'exposure-alternative'
  ...
  factory EffectEvidenceSynthesisResultsByExposure.fromJson(Map<String, dynamic> json) {
    return EffectEvidenceSynthesisResultsByExposure(
      ...
      riskEvidenceSynthesis: Reference.fromJson(json['riskEvidenceSynthesis'] as Map<String, dynamic>),
  ...
  EffectEvidenceSynthesisResultsByExposure copyWith({
    ...
    return EffectEvidenceSynthesisResultsByExposure(
      ...
      riskEvidenceSynthesis: riskEvidenceSynthesis ?? this.riskEvidenceSynthesis,
