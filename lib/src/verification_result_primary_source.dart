...
class VerificationResultPrimarySource extends BackboneElement implements FhirResource {
   /// yes | no | undetermined
  ...
  factory VerificationResultPrimarySource.fromJson(Map<String, dynamic> json) {
    return VerificationResultPrimarySource(
      canPushUpdates: json['canPushUpdates'] != null ? CodeableConcept.fromJson(json['canPushUpdates'] as Map<String, dynamic>) : null,
      communicationMethod: (json['communicationMethod'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      pushTypeAvailable: (json['pushTypeAvailable'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      validationStatus: json['validationStatus'] != null ? CodeableConcept.fromJson(json['validationStatus'] as Map<String, dynamic>) : null,
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'communicationMethod': communicationMethod?.map((e) => e.toJson()).toList(),
