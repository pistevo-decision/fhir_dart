...
class MedicinalProductContraindication extends DomainResource implements FhirResource {
  /// Resource Type Name (for serialization) 
  static const resourceType = 'MedicinalProductContraindication';
  ...
  factory MedicinalProductContraindication.fromJson(Map<String, dynamic> json) {
    return MedicinalProductContraindication(
      ...
      disease: json['disease'] != null ? CodeableConcept.fromJson(json['disease'] as Map<String, dynamic>) : null,
      ...
      otherTherapy: (json['otherTherapy'] as List<dynamic>?)?.map((e) => MedicinalProductContraindicationOtherTherapy.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      therapeuticIndication: (json['therapeuticIndication'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'text': text?.toJson(),
      'therapeuticIndication': therapeuticIndication?.map((e) => e.toJson()).toList(),
    };
  ...
  MedicinalProductContraindication copyWith({
    ...
    return MedicinalProductContraindication(
      ...
      text: text ?? this.text,
      therapeuticIndication: therapeuticIndication ?? this.therapeuticIndication,
    );
  }
}
