...
class AdverseEventSuspectEntity extends BackboneElement implements FhirResource {
  ...
  factory AdverseEventSuspectEntity.fromJson(Map<String, dynamic> json) {
    return AdverseEventSuspectEntity(
      causality: (json['causality'] as List<dynamic>?)?.map((e) => AdverseEventSuspectEntityCausality.fromJson(e as Map<String, dynamic>)).toList(),
