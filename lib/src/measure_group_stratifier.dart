...
class MeasureGroupStratifier extends BackboneElement implements FhirResource {
  ...
  factory MeasureGroupStratifier.fromJson(Map<String, dynamic> json) {
    return MeasureGroupStratifier(
      ...
      component: (json['component'] as List<dynamic>?)?.map((e) => MeasureGroupStratifierComponent.fromJson(e as Map<String, dynamic>)).toList(),
      criteria: json['criteria'] != null ? Expression.fromJson(json['criteria'] as Map<String, dynamic>) : null,
