...
class SubstanceSourceMaterialOrganismHybrid extends BackboneElement implements FhirResource {
  ...
  @override
  factory SubstanceSourceMaterialOrganismHybrid.fromJson(Map<String, dynamic> json) {
    return SubstanceSourceMaterialOrganismHybrid(
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      hybridType: json['hybridType'] != null ? CodeableConcept.fromJson(json['hybridType'] as Map<String, dynamic>) : null,
