...
class CapabilityStatementRestResourceInteraction extends BackboneElement
  ...
  final String
      code; // Possible values: 'read', 'vread', 'update', 'patch', 'delete', 'history-instance', 'history-type', 'create', 'search-type'
  ...
  @override
  factory CapabilityStatementRestResourceInteraction.fromJson(
