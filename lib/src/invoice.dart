...
class Invoice extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'draft', 'issued', 'balanced', 'cancelled', 'entered-in-error'
  ...
  factory Invoice.fromJson(Map<String, dynamic> json) {
    return Invoice(
      account: json['account'] != null ? Reference.fromJson(json['account'] as Map<String, dynamic>) : null,
      ...
      lineItem: (json['lineItem'] as List<dynamic>?)?.map((e) => InvoiceLineItem.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      participant: (json['participant'] as List<dynamic>?)?.map((e) => InvoiceParticipant.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      totalGross: json['totalGross'] != null ? Money.fromJson(json['totalGross'] as Map<String, dynamic>) : null,
      totalNet: json['totalNet'] != null ? Money.fromJson(json['totalNet'] as Map<String, dynamic>) : null,
      totalPriceComponent: (json['totalPriceComponent'] as List<dynamic>?)?.map((e) => InvoiceLineItemPriceComponent.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'totalPriceComponent': totalPriceComponent?.map((e) => e.toJson()).toList(),
      'type': type?.toJson(),
    };
