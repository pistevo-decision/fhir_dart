...
class Procedure extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'preparation', 'in-progress', 'not-done', 'on-hold', 'stopped', 'completed', 'entered-in-error', 'unknown'
  ...
  factory Procedure.fromJson(Map<String, dynamic> json) {
    return Procedure(
      ...
      complication: (json['complication'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      complicationDetail: (json['complicationDetail'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      focalDevice: (json['focalDevice'] as List<dynamic>?)?.map((e) => ProcedureFocalDevice.fromJson(e as Map<String, dynamic>)).toList(),
      followUp: (json['followUp'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      performedAge: json['performedAge'] != null ? Age.fromJson(json['performedAge'] as Map<String, dynamic>) : null,
      performedDateTime: json['performedDateTime'] as String?,
      performedPeriod: json['performedPeriod'] != null ? Period.fromJson(json['performedPeriod'] as Map<String, dynamic>) : null,
      performedRange: json['performedRange'] != null ? Range.fromJson(json['performedRange'] as Map<String, dynamic>) : null,
      performedString: json['performedString'] as String?,
      performer: (json['performer'] as List<dynamic>?)?.map((e) => ProcedurePerformer.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      report: (json['report'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      usedCode: (json['usedCode'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      usedReference: (json['usedReference'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'complicationDetail': complicationDetail?.map((e) => e.toJson()).toList(),
