...
class OperationOutcomeIssue extends BackboneElement implements FhirResource {
  ...
  final String severity; // Possible values: 'fatal', 'error', 'warning', 'information'
  ...
  factory OperationOutcomeIssue.fromJson(Map<String, dynamic> json) {
    return OperationOutcomeIssue(
      ...
      details: json['details'] != null ? CodeableConcept.fromJson(json['details'] as Map<String, dynamic>) : null,
      diagnostics: json['diagnostics'] as String?,
      expression: (json['expression'] as List<dynamic>?)?.map((e) => e as String).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      location: (json['location'] as List<dynamic>?)?.map((e) => e as String).toList(),
