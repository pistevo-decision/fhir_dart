...
class NutritionOrderEnteralFormulaAdministration extends BackboneElement implements FhirResource {
  ...
  @override
  factory NutritionOrderEnteralFormulaAdministration.fromJson(Map<String, dynamic> json) {
    return NutritionOrderEnteralFormulaAdministration(
      ...
      schedule: json['schedule'] != null ? Timing.fromJson(json['schedule'] as Map<String, dynamic>) : null,
    );
    }
