...
class QuestionnaireItem extends BackboneElement implements FhirResource {
  ...
  final String type; // Possible values: 'group', 'display', 'boolean', 'decimal', 'integer', 'date', 'dateTime', 'time', 'string', 'text', 'url', 'choice', 'open-choice', 'attachment', 'reference', 'quantity'
  QuestionnaireItem({
    this.answerOption,
    this.answerValueSet,
    this.code,
  ...
  factory QuestionnaireItem.fromJson(Map<String, dynamic> json) {
    return QuestionnaireItem(
      answerOption: (json['answerOption'] as List<dynamic>?)?.map((e) => QuestionnaireItemAnswerOption.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      enableWhen: (json['enableWhen'] as List<dynamic>?)?.map((e) => QuestionnaireItemEnableWhen.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      initial: (json['initial'] as List<dynamic>?)?.map((e) => QuestionnaireItemInitial.fromJson(e as Map<String, dynamic>)).toList(),
      item: (json['item'] as List<dynamic>?)?.map((e) => QuestionnaireItem.fromJson(e as Map<String, dynamic>)).toList(),
