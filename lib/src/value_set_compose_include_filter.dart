...
class ValueSetComposeIncludeFilter extends BackboneElement implements FhirResource {
  ...
  final String op; // Possible values: '=', 'is-a', 'descendent-of', 'is-not-a', 'regex', 'in', 'not-in', 'generalizes', 'exists'
