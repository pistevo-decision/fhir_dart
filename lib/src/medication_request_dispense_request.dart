...
class MedicationRequestDispenseRequest extends BackboneElement implements FhirResource {
  ...
  factory MedicationRequestDispenseRequest.fromJson(Map<String, dynamic> json) {
    return MedicationRequestDispenseRequest(
      dispenseInterval: json['dispenseInterval'] != null ? Duration.fromJson(json['dispenseInterval'] as Map<String, dynamic>) : null,
      expectedSupplyDuration: json['expectedSupplyDuration'] != null ? Duration.fromJson(json['expectedSupplyDuration'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      initialFill: json['initialFill'] != null ? MedicationRequestDispenseRequestInitialFill.fromJson(json['initialFill'] as Map<String, dynamic>) : null,
  ...
  MedicationRequestDispenseRequest copyWith({
    ...
    return MedicationRequestDispenseRequest(
      ...
      expectedSupplyDuration: expectedSupplyDuration ?? this.expectedSupplyDuration,
      fhirExtension: fhirExtension ?? this.fhirExtension,
      id: id ?? this.id,
      initialFill: initialFill ?? this.initialFill,
      modifierExtension: modifierExtension ?? this.modifierExtension,
      numberOfRepeatsAllowed: numberOfRepeatsAllowed ?? this.numberOfRepeatsAllowed,
