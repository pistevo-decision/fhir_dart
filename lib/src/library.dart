...
class Library extends DomainResource implements FhirResource {
  ...
  factory Library.fromJson(Map<String, dynamic> json) {
    return Library(
      ...
      content: (json['content'] as List<dynamic>?)?.map((e) => Attachment.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => ParameterDefinition.fromJson(e as Map<String, dynamic>)).toList(),
