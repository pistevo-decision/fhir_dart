...
class Identifier extends Element implements FhirResource {
  ...
  final String? use; // Possible values: 'usual', 'official', 'temp', 'secondary', 'old'
  ...
  factory Identifier.fromJson(Map<String, dynamic> json) {
    return Identifier(
      assigner: json['assigner'] != null ? Reference.fromJson(json['assigner'] as Map<String, dynamic>) : null,
