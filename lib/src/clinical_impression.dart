...
class ClinicalImpression extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'in-progress', 'completed', 'entered-in-error'
  ...
  factory ClinicalImpression.fromJson(Map<String, dynamic> json) {
    return ClinicalImpression(
      assessor: json['assessor'] != null ? Reference.fromJson(json['assessor'] as Map<String, dynamic>) : null,
      ...
      finding: (json['finding'] as List<dynamic>?)?.map((e) => ClinicalImpressionFinding.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      identifier: (json['identifier'] as List<dynamic>?)?.map((e) => Identifier.fromJson(e as Map<String, dynamic>)).toList(),
      implicitRules: json['implicitRules'] as String?,
      investigation: (json['investigation'] as List<dynamic>?)?.map((e) => ClinicalImpressionInvestigation.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      previous: json['previous'] != null ? Reference.fromJson(json['previous'] as Map<String, dynamic>) : null,
      problem: (json['problem'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      prognosisCodeableConcept: (json['prognosisCodeableConcept'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      prognosisReference: (json['prognosisReference'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'prognosisCodeableConcept': prognosisCodeableConcept?.map((e) => e.toJson()).toList(),
      'prognosisReference': prognosisReference?.map((e) => e.toJson()).toList(),
  ...
  ClinicalImpression copyWith({
    ...
    return ClinicalImpression(
      ...
      prognosisCodeableConcept: prognosisCodeableConcept ?? this.prognosisCodeableConcept,
