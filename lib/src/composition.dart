...
class Composition extends DomainResource implements FhirResource {
  ...
  final String? confidentiality; // Possible values: 'U', 'L', 'M', 'N', 'R', 'V'
  ...
  final String status; // Possible values: 'preliminary', 'final', 'amended', 'entered-in-error'
  ...
  factory Composition.fromJson(Map<String, dynamic> json) {
    return Composition(
      attester: (json['attester'] as List<dynamic>?)?.map((e) => CompositionAttester.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      event: (json['event'] as List<dynamic>?)?.map((e) => CompositionEvent.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      relatesTo: (json['relatesTo'] as List<dynamic>?)?.map((e) => CompositionRelatesTo.fromJson(e as Map<String, dynamic>)).toList(),
      section: (json['section'] as List<dynamic>?)?.map((e) => CompositionSection.fromJson(e as Map<String, dynamic>)).toList(),
