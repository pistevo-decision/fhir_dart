...
class InsurancePlanPlanSpecificCost extends BackboneElement implements FhirResource {
   /// Benefits list
  ...
  factory InsurancePlanPlanSpecificCost.fromJson(Map<String, dynamic> json) {
    return InsurancePlanPlanSpecificCost(
      benefit: (json['benefit'] as List<dynamic>?)?.map((e) => InsurancePlanPlanSpecificCostBenefit.fromJson(e as Map<String, dynamic>)).toList(),
