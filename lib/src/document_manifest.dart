...
class DocumentManifest extends DomainResource implements FhirResource {
  ...
  factory DocumentManifest.fromJson(Map<String, dynamic> json) {
    return DocumentManifest(
      ...
      content: (json['content'] as List<dynamic>).map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      related: (json['related'] as List<dynamic>?)?.map((e) => DocumentManifestRelated.fromJson(e as Map<String, dynamic>)).toList(),
