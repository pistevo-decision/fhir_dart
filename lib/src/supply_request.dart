...
class SupplyRequest extends DomainResource implements FhirResource {
  ...
  final String? status; // Possible values: 'draft', 'active', 'suspended', 'cancelled', 'completed', 'entered-in-error', 'unknown'
  ...
  factory SupplyRequest.fromJson(Map<String, dynamic> json) {
    return SupplyRequest(
      ...
      deliverFrom: json['deliverFrom'] != null ? Reference.fromJson(json['deliverFrom'] as Map<String, dynamic>) : null,
      deliverTo: json['deliverTo'] != null ? Reference.fromJson(json['deliverTo'] as Map<String, dynamic>) : null,
      ...
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => SupplyRequestParameter.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      supplier: (json['supplier'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
