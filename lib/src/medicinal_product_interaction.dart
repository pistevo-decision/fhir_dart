...
class MedicinalProductInteraction extends DomainResource implements FhirResource {
  ...
  factory MedicinalProductInteraction.fromJson(Map<String, dynamic> json) {
    return MedicinalProductInteraction(
      ...
      effect: json['effect'] != null ? CodeableConcept.fromJson(json['effect'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      implicitRules: json['implicitRules'] as String?,
      incidence: json['incidence'] != null ? CodeableConcept.fromJson(json['incidence'] as Map<String, dynamic>) : null,
      interactant: (json['interactant'] as List<dynamic>?)?.map((e) => MedicinalProductInteractionInteractant.fromJson(e as Map<String, dynamic>)).toList(),
      language: json['language'] as String?,
      management: json['management'] != null ? CodeableConcept.fromJson(json['management'] as Map<String, dynamic>) : null,
