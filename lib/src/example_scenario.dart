...
class ExampleScenario extends DomainResource implements FhirResource {
  ...
  factory ExampleScenario.fromJson(Map<String, dynamic> json) {
    return ExampleScenario(
      actor: (json['actor'] as List<dynamic>?)?.map((e) => ExampleScenarioActor.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      instance: (json['instance'] as List<dynamic>?)?.map((e) => ExampleScenarioInstance.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      workflow: (json['workflow'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );
    }
