...
class ExplanationOfBenefitItemDetail extends BackboneElement implements FhirResource {
  ...
  factory ExplanationOfBenefitItemDetail.fromJson(Map<String, dynamic> json) {
    return ExplanationOfBenefitItemDetail(
      ...
      subDetail: (json['subDetail'] as List<dynamic>?)?.map((e) => ExplanationOfBenefitItemDetailSubDetail.fromJson(e as Map<String, dynamic>)).toList(),
