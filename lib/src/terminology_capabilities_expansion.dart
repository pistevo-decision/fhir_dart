...
class TerminologyCapabilitiesExpansion extends BackboneElement implements FhirResource {
  ...
  factory TerminologyCapabilitiesExpansion.fromJson(Map<String, dynamic> json) {
    return TerminologyCapabilitiesExpansion(
      ...
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => TerminologyCapabilitiesExpansionParameter.fromJson(e as Map<String, dynamic>)).toList(),
