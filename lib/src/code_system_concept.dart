...
class CodeSystemConcept extends BackboneElement implements FhirResource {
  ...
  factory CodeSystemConcept.fromJson(Map<String, dynamic> json) {
    return CodeSystemConcept(
      ...
      designation: (json['designation'] as List<dynamic>?)?.map((e) => CodeSystemConceptDesignation.fromJson(e as Map<String, dynamic>)).toList(),
      display: json['display'] as String?,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      property: (json['property'] as List<dynamic>?)?.map((e) => CodeSystemConceptProperty.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
