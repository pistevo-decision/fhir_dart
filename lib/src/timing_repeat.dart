...
class TimingRepeat extends Element implements FhirResource {
  ...
  final List<String>?
      dayOfWeek; // Possible values: 'mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'
  ...
  final String?
      durationUnit; // Possible values: 's', 'min', 'h', 'd', 'wk', 'mo', 'a'
  ...
  final String?
      periodUnit; // Possible values: 's', 'min', 'h', 'd', 'wk', 'mo', 'a'
  ...
  final List<String>?
      when; // Possible values: 'MORN', 'MORN.early', 'MORN.late', 'NOON', 'AFT', 'AFT.early', 'AFT.late', 'EVE', 'EVE.early', 'EVE.late', 'NIGHT', 'PHS', 'HS', 'WAKE', 'C', 'CM', 'CD', 'CV', 'AC', 'ACM', 'ACD', 'ACV', 'PC', 'PCM', 'PCD', 'PCV'
  TimingRepeat({
    this.boundsDuration,
    this.boundsPeriod,
    this.boundsRange,
