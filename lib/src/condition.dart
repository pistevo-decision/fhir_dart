  ...
  factory Condition.fromJson(Map<String, dynamic> json) {
    return Condition(
      abatementAge: json['abatementAge'] != null
          ? Age.fromJson((json['abatementAge'] as Map).cast<String, dynamic>())
          : null,
      abatementDateTime: json['abatementDateTime'] as String?,
      abatementPeriod: json['abatementPeriod'] != null
          ? Period.fromJson(
              (json['abatementPeriod'] as Map).cast<String, dynamic>())
          : null,
      abatementRange: json['abatementRange'] != null
          ? Range.fromJson(
              (json['abatementRange'] as Map).cast<String, dynamic>())
          : null,
      ...
      evidence: (json['evidence'] as List<dynamic>?)
          ?.map((e) =>
              ConditionEvidence.fromJson((e as Map).cast<String, dynamic>()))
          .toList(),
      ...
      stage: (json['stage'] as List<dynamic>?)
          ?.map((e) =>
              ConditionStage.fromJson((e as Map).cast<String, dynamic>()))
          .toList(),
      subject:
