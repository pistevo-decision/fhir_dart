part of '../fhir_dart.dart';
 ...
 /// Product storage.
class BiologicallyDerivedProductStorage extends BackboneElement implements FhirResource {
  ...
  factory BiologicallyDerivedProductStorage.fromJson(Map<String, dynamic> json) {
    return BiologicallyDerivedProductStorage(
      ...
      duration: json['duration'] != null ? Period.fromJson(json['duration'] as Map<String, dynamic>) : null,
