...
class DeviceDefinition extends DomainResource implements FhirResource {
  ...
  factory DeviceDefinition.fromJson(Map<String, dynamic> json) {
    return DeviceDefinition(
      capability: (json['capability'] as List<dynamic>?)?.map((e) => DeviceDefinitionCapability.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      deviceName: (json['deviceName'] as List<dynamic>?)?.map((e) => DeviceDefinitionDeviceName.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      languageCode: (json['languageCode'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      manufacturerReference: json['manufacturerReference'] != null ? Reference.fromJson(json['manufacturerReference'] as Map<String, dynamic>) : null,
      manufacturerString: json['manufacturerString'] as String?,
      material: (json['material'] as List<dynamic>?)?.map((e) => DeviceDefinitionMaterial.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      parentDevice: json['parentDevice'] != null ? Reference.fromJson(json['parentDevice'] as Map<String, dynamic>) : null,
      ...
      property: (json['property'] as List<dynamic>?)?.map((e) => DeviceDefinitionProperty.fromJson(e as Map<String, dynamic>)).toList(),
      quantity: json['quantity'] != null ? Quantity.fromJson(json['quantity'] as Map<String, dynamic>) : null,
      safety: (json['safety'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      shelfLifeStorage: (json['shelfLifeStorage'] as List<dynamic>?)?.map((e) => ProductShelfLife.fromJson(e as Map<String, dynamic>)).toList(),
      specialization: (json['specialization'] as List<dynamic>?)?.map((e) => DeviceDefinitionSpecialization.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      udiDeviceIdentifier: (json['udiDeviceIdentifier'] as List<dynamic>?)?.map((e) => DeviceDefinitionUdiDeviceIdentifier.fromJson(e as Map<String, dynamic>)).toList(),
      url: json['url'] as String?,
      version: (json['version'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );
    }
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'text': text?.toJson(),
      'type': type?.toJson(),
      'udiDeviceIdentifier': udiDeviceIdentifier?.map((e) => e.toJson()).toList(),
      'url': url,
  ...
  DeviceDefinition copyWith({
    ...
    return DeviceDefinition(
      ...
      manufacturerReference: manufacturerReference ?? this.manufacturerReference,
