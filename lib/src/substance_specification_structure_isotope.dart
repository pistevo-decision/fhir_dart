...
class SubstanceSpecificationStructureIsotope extends BackboneElement implements FhirResource {
  ...
  @override
  factory SubstanceSpecificationStructureIsotope.fromJson(Map<String, dynamic> json) {
    return SubstanceSpecificationStructureIsotope(
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      halfLife: json['halfLife'] != null ? Quantity.fromJson(json['halfLife'] as Map<String, dynamic>) : null,
      id: json['id'] as String?,
      identifier: json['identifier'] != null ? Identifier.fromJson(json['identifier'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      molecularWeight: json['molecularWeight'] != null ? SubstanceSpecificationStructureIsotopeMolecularWeight.fromJson(json['molecularWeight'] as Map<String, dynamic>) : null,
      name: json['name'] != null ? CodeableConcept.fromJson(json['name'] as Map<String, dynamic>) : null,
      substitution: json['substitution'] != null ? CodeableConcept.fromJson(json['substitution'] as Map<String, dynamic>) : null,
    );
    }
