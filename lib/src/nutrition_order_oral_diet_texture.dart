...
class NutritionOrderOralDietTexture extends BackboneElement implements FhirResource {
  ...
  factory NutritionOrderOralDietTexture.fromJson(Map<String, dynamic> json) {
    return NutritionOrderOralDietTexture(
      ...
      foodType: json['foodType'] != null ? CodeableConcept.fromJson(json['foodType'] as Map<String, dynamic>) : null,
