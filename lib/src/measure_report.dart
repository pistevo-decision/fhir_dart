...
class MeasureReport extends DomainResource implements FhirResource {
  ...
  final String type; // Possible values: 'individual', 'subject-list', 'summary', 'data-collection'
  MeasureReport({
    super.contained,
    this.date,
  ...
  factory MeasureReport.fromJson(Map<String, dynamic> json) {
    return MeasureReport(
      ...
      evaluatedResource: (json['evaluatedResource'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      group: (json['group'] as List<dynamic>?)?.map((e) => MeasureReportGroup.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      reporter: json['reporter'] != null ? Reference.fromJson(json['reporter'] as Map<String, dynamic>) : null,
