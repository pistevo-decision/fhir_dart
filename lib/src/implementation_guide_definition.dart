...
class ImplementationGuideDefinition extends BackboneElement implements FhirResource {
  ...
  factory ImplementationGuideDefinition.fromJson(Map<String, dynamic> json) {
    return ImplementationGuideDefinition(
      ...
      grouping: (json['grouping'] as List<dynamic>?)?.map((e) => ImplementationGuideDefinitionGrouping.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      page: json['page'] != null ? ImplementationGuideDefinitionPage.fromJson(json['page'] as Map<String, dynamic>) : null,
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => ImplementationGuideDefinitionParameter.fromJson(e as Map<String, dynamic>)).toList(),
      resource: (json['resource'] as List<dynamic>).map((e) => ImplementationGuideDefinitionResource.fromJson(e as Map<String, dynamic>)).toList(),
      template: (json['template'] as List<dynamic>?)?.map((e) => ImplementationGuideDefinitionTemplate.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
