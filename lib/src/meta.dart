...
class Meta extends Element implements FhirResource {
  ...
  factory Meta.fromJson(Map<String, dynamic> json) {
    return Meta(
      ...
      security: (json['security'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
      source: json['source'] as String?,
      tag: (json['tag'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
