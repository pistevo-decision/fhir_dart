...
class SubstancePolymer extends DomainResource implements FhirResource {
  ...
  factory SubstancePolymer.fromJson(Map<String, dynamic> json) {
    return SubstancePolymer(
      ...
      copolymerConnectivity: (json['copolymerConnectivity'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      geometry: json['geometry'] != null ? CodeableConcept.fromJson(json['geometry'] as Map<String, dynamic>) : null,
      id: json['id'] as String?,
      implicitRules: json['implicitRules'] as String?,
      language: json['language'] as String?,
      meta: json['meta'] != null ? Meta.fromJson(json['meta'] as Map<String, dynamic>) : null,
      modification: (json['modification'] as List<dynamic>?)?.map((e) => e as String).toList(),
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      monomerSet: (json['monomerSet'] as List<dynamic>?)?.map((e) => SubstancePolymerMonomerSet.fromJson(e as Map<String, dynamic>)).toList(),
      repeat: (json['repeat'] as List<dynamic>?)?.map((e) => SubstancePolymerRepeat.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'copolymerConnectivity': copolymerConnectivity?.map((e) => e.toJson()).toList(),
  ...
  SubstancePolymer copyWith({
    ...
    return SubstancePolymer(
      ...
      copolymerConnectivity: copolymerConnectivity ?? this.copolymerConnectivity,
