...
class MeasureReportGroup extends BackboneElement implements FhirResource {
  ...
  factory MeasureReportGroup.fromJson(Map<String, dynamic> json) {
    return MeasureReportGroup(
      ...
      population: (json['population'] as List<dynamic>?)?.map((e) => MeasureReportGroupPopulation.fromJson(e as Map<String, dynamic>)).toList(),
      stratifier: (json['stratifier'] as List<dynamic>?)?.map((e) => MeasureReportGroupStratifier.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
