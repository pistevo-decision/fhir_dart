...
class SpecimenDefinitionTypeTestedContainerAdditive extends BackboneElement implements FhirResource {
   /// Additive associated with container
   /// Substance introduced in the kind of container to preserve, maintain or enhance the specimen. Examples: Formalin, Citrate, EDTA.
  ...
  @override
  factory SpecimenDefinitionTypeTestedContainerAdditive.fromJson(Map<String, dynamic> json) {
