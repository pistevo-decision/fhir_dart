...
class Endpoint extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'active', 'suspended', 'error', 'off', 'entered-in-error', 'test'
  Endpoint({
  ...
  factory Endpoint.fromJson(Map<String, dynamic> json) {
    return Endpoint(
      ...
      connectionType: Coding.fromJson(json['connectionType'] as Map<String, dynamic>),
      ...
      payloadMimeType: (json['payloadMimeType'] as List<dynamic>?)?.map((e) => e as String).toList(),
      payloadType: (json['payloadType'] as List<dynamic>).map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
