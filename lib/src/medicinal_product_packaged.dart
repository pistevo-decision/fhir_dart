...
class MedicinalProductPackaged extends DomainResource implements FhirResource {
  ...
  factory MedicinalProductPackaged.fromJson(Map<String, dynamic> json) {
    return MedicinalProductPackaged(
      batchIdentifier: (json['batchIdentifier'] as List<dynamic>?)?.map((e) => MedicinalProductPackagedBatchIdentifier.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      marketingAuthorization: json['marketingAuthorization'] != null ? Reference.fromJson(json['marketingAuthorization'] as Map<String, dynamic>) : null,
  ...
  MedicinalProductPackaged copyWith({
    ...
    return MedicinalProductPackaged(
      ...
      marketingAuthorization: marketingAuthorization ?? this.marketingAuthorization,
