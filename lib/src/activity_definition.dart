...
class ActivityDefinition extends DomainResource implements FhirResource {
  ...
  final String? kind; // Possible values: 'Appointment', 'AppointmentResponse', 'CarePlan', 'Claim', 'CommunicationRequest', 'Contract', 'DeviceRequest', 'EnrollmentRequest', 'ImmunizationRecommendation', 'MedicationRequest', 'NutritionOrder', 'ServiceRequest', 'SupplyRequest', 'Task', 'VisionPrescription'
  ...
  factory ActivityDefinition.fromJson(Map<String, dynamic> json) {
    return ActivityDefinition(
      ...
      dynamicValue: (json['dynamicValue'] as List<dynamic>?)?.map((e) => ActivityDefinitionDynamicValue.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      observationRequirement: (json['observationRequirement'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      observationResultRequirement: (json['observationResultRequirement'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      participant: (json['participant'] as List<dynamic>?)?.map((e) => ActivityDefinitionParticipant.fromJson(e as Map<String, dynamic>)).toList(),
      priority: json['priority'] as String?,
      productCodeableConcept: json['productCodeableConcept'] != null ? CodeableConcept.fromJson(json['productCodeableConcept'] as Map<String, dynamic>) : null,
      productReference: json['productReference'] != null ? Reference.fromJson(json['productReference'] as Map<String, dynamic>) : null,
      ...
      specimenRequirement: (json['specimenRequirement'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      timingAge: json['timingAge'] != null ? Age.fromJson(json['timingAge'] as Map<String, dynamic>) : null,
      timingDateTime: json['timingDateTime'] as String?,
      timingDuration: json['timingDuration'] != null ? Duration.fromJson(json['timingDuration'] as Map<String, dynamic>) : null,
      timingPeriod: json['timingPeriod'] != null ? Period.fromJson(json['timingPeriod'] as Map<String, dynamic>) : null,
      timingRange: json['timingRange'] != null ? Range.fromJson(json['timingRange'] as Map<String, dynamic>) : null,
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'name': name,
      'observationRequirement': observationRequirement?.map((e) => e.toJson()).toList(),
      'observationResultRequirement': observationResultRequirement?.map((e) => e.toJson()).toList(),
      ...
      'specimenRequirement': specimenRequirement?.map((e) => e.toJson()).toList(),
      'status': status,
  ...
  ActivityDefinition copyWith({
    ...
    return ActivityDefinition(
      ...
      name: name ?? this.name,
      observationRequirement: observationRequirement ?? this.observationRequirement,
      observationResultRequirement: observationResultRequirement ?? this.observationResultRequirement,
      participant: participant ?? this.participant,
      priority: priority ?? this.priority,
      productCodeableConcept: productCodeableConcept ?? this.productCodeableConcept,
