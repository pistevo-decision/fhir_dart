...
class DeviceProperty extends BackboneElement implements FhirResource {
  ...
  factory DeviceProperty.fromJson(Map<String, dynamic> json) {
    return DeviceProperty(
      ...
      valueCode: (json['valueCode'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      valueQuantity: (json['valueQuantity'] as List<dynamic>?)?.map((e) => Quantity.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
