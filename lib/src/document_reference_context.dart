...
class DocumentReferenceContext extends BackboneElement implements FhirResource {
  ...
  factory DocumentReferenceContext.fromJson(Map<String, dynamic> json) {
    return DocumentReferenceContext(
      ...
      event: (json['event'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      facilityType: json['facilityType'] != null ? CodeableConcept.fromJson(json['facilityType'] as Map<String, dynamic>) : null,
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      period: json['period'] != null ? Period.fromJson(json['period'] as Map<String, dynamic>) : null,
      practiceSetting: json['practiceSetting'] != null ? CodeableConcept.fromJson(json['practiceSetting'] as Map<String, dynamic>) : null,
      related: (json['related'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      sourcePatientInfo: json['sourcePatientInfo'] != null ? Reference.fromJson(json['sourcePatientInfo'] as Map<String, dynamic>) : null,
    );
    }
