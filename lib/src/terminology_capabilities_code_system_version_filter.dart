...
class TerminologyCapabilitiesCodeSystemVersionFilter extends BackboneElement implements FhirResource {
  ...
  @override
  factory TerminologyCapabilitiesCodeSystemVersionFilter.fromJson(Map<String, dynamic> json) {
