...
class StructureMapGroupRuleSource extends BackboneElement implements FhirResource {
  ...
  final String? listMode; // Possible values: 'first', 'not_first', 'last', 'not_last', 'only_one'
