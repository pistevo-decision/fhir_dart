...
class MedicationRequest extends DomainResource implements FhirResource {
  ...
  final String intent; // Possible values: 'proposal', 'plan', 'order', 'original-order', 'reflex-order', 'filler-order', 'instance-order', 'option'
  ...
  final String status; // Possible values: 'active', 'on-hold', 'cancelled', 'completed', 'entered-in-error', 'stopped', 'draft', 'unknown'
  ...
  factory MedicationRequest.fromJson(Map<String, dynamic> json) {
    return MedicationRequest(
      ...
      courseOfTherapyType: json['courseOfTherapyType'] != null ? CodeableConcept.fromJson(json['courseOfTherapyType'] as Map<String, dynamic>) : null,
      detectedIssue: (json['detectedIssue'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      dispenseRequest: json['dispenseRequest'] != null ? MedicationRequestDispenseRequest.fromJson(json['dispenseRequest'] as Map<String, dynamic>) : null,
      ...
      priorPrescription: json['priorPrescription'] != null ? Reference.fromJson(json['priorPrescription'] as Map<String, dynamic>) : null,
      ...
      reportedReference: json['reportedReference'] != null ? Reference.fromJson(json['reportedReference'] as Map<String, dynamic>) : null,
      ...
      substitution: json['substitution'] != null ? MedicationRequestSubstitution.fromJson(json['substitution'] as Map<String, dynamic>) : null,
