...
class VerificationResultValidator extends BackboneElement implements FhirResource {
   /// Validator signature
  ...
  factory VerificationResultValidator.fromJson(Map<String, dynamic> json) {
    return VerificationResultValidator(
      attestationSignature: json['attestationSignature'] != null ? Signature.fromJson(json['attestationSignature'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      identityCertificate: json['identityCertificate'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      organization: Reference.fromJson(json['organization'] as Map<String, dynamic>),
    );
    }
