...
class CatalogEntry extends DomainResource implements FhirResource {
  ...
  factory CatalogEntry.fromJson(Map<String, dynamic> json) {
    return CatalogEntry(
      additionalCharacteristic: (json['additionalCharacteristic'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      additionalClassification: (json['additionalClassification'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      additionalIdentifier: (json['additionalIdentifier'] as List<dynamic>?)?.map((e) => Identifier.fromJson(e as Map<String, dynamic>)).toList(),
      classification: (json['classification'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      referencedItem: Reference.fromJson(json['referencedItem'] as Map<String, dynamic>),
      relatedEntry: (json['relatedEntry'] as List<dynamic>?)?.map((e) => CatalogEntryRelatedEntry.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      'additionalCharacteristic': additionalCharacteristic?.map((e) => e.toJson()).toList(),
      'additionalClassification': additionalClassification?.map((e) => e.toJson()).toList(),
      'additionalIdentifier': additionalIdentifier?.map((e) => e.toJson()).toList(),
  ...
  CatalogEntry copyWith({
    ...
    return CatalogEntry(
      additionalCharacteristic: additionalCharacteristic ?? this.additionalCharacteristic,
      additionalClassification: additionalClassification ?? this.additionalClassification,
