...
class CoverageEligibilityResponseInsuranceItem extends BackboneElement implements FhirResource {
  ...
  @override
  factory CoverageEligibilityResponseInsuranceItem.fromJson(Map<String, dynamic> json) {
    return CoverageEligibilityResponseInsuranceItem(
      authorizationRequired: json['authorizationRequired'] as bool?,
      authorizationSupporting: (json['authorizationSupporting'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      authorizationUrl: json['authorizationUrl'] as String?,
      benefit: (json['benefit'] as List<dynamic>?)?.map((e) => CoverageEligibilityResponseInsuranceItemBenefit.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      productOrService: json['productOrService'] != null ? CodeableConcept.fromJson(json['productOrService'] as Map<String, dynamic>) : null,
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'authorizationSupporting': authorizationSupporting?.map((e) => e.toJson()).toList(),
  ...
  CoverageEligibilityResponseInsuranceItem copyWith({
    ...
    return CoverageEligibilityResponseInsuranceItem(
      ...
      authorizationSupporting: authorizationSupporting ?? this.authorizationSupporting,
