...
class SubstanceSpecification extends DomainResource implements FhirResource {
  ...
  final List<SubstanceSpecificationStructureIsotopeMolecularWeight>? molecularWeight;
  ...
  factory SubstanceSpecification.fromJson(Map<String, dynamic> json) {
    return SubstanceSpecification(
      code: (json['code'] as List<dynamic>?)?.map((e) => SubstanceSpecificationCode.fromJson(e as Map<String, dynamic>)).toList(),
      comment: json['comment'] as String?,
      contained: (json['contained'] as List<dynamic>?)?.map((e) => Resource.fromJson(e as Map<String, dynamic>)).toList(),
      description: json['description'] as String?,
      domain: json['domain'] != null ? CodeableConcept.fromJson(json['domain'] as Map<String, dynamic>) : null,
      ...
      moiety: (json['moiety'] as List<dynamic>?)?.map((e) => SubstanceSpecificationMoiety.fromJson(e as Map<String, dynamic>)).toList(),
      molecularWeight: (json['molecularWeight'] as List<dynamic>?)?.map((e) => SubstanceSpecificationStructureIsotopeMolecularWeight.fromJson(e as Map<String, dynamic>)).toList(),
      name: (json['name'] as List<dynamic>?)?.map((e) => SubstanceSpecificationName.fromJson(e as Map<String, dynamic>)).toList(),
      nucleicAcid: json['nucleicAcid'] != null ? Reference.fromJson(json['nucleicAcid'] as Map<String, dynamic>) : null,
      polymer: json['polymer'] != null ? Reference.fromJson(json['polymer'] as Map<String, dynamic>) : null,
      property: (json['property'] as List<dynamic>?)?.map((e) => SubstanceSpecificationProperty.fromJson(e as Map<String, dynamic>)).toList(),
      protein: json['protein'] != null ? Reference.fromJson(json['protein'] as Map<String, dynamic>) : null,
      referenceInformation: json['referenceInformation'] != null ? Reference.fromJson(json['referenceInformation'] as Map<String, dynamic>) : null,
      relationship: (json['relationship'] as List<dynamic>?)?.map((e) => SubstanceSpecificationRelationship.fromJson(e as Map<String, dynamic>)).toList(),
      source: (json['source'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      sourceMaterial: json['sourceMaterial'] != null ? Reference.fromJson(json['sourceMaterial'] as Map<String, dynamic>) : null,
      status: json['status'] != null ? CodeableConcept.fromJson(json['status'] as Map<String, dynamic>) : null,
      structure: json['structure'] != null ? SubstanceSpecificationStructure.fromJson(json['structure'] as Map<String, dynamic>) : null,
  ...
  SubstanceSpecification copyWith({
    ...
    List<SubstanceSpecificationStructureIsotopeMolecularWeight>? molecularWeight,
