...
class MolecularSequenceQualityRoc extends BackboneElement implements FhirResource {
  ...
  factory MolecularSequenceQualityRoc.fromJson(Map<String, dynamic> json) {
    return MolecularSequenceQualityRoc(
      ...
      fMeasure: (json['fMeasure'] as List<dynamic>?)?.map((e) => e as num).toList(),
      ...
      precision: (json['precision'] as List<dynamic>?)?.map((e) => e as num).toList(),
      score: (json['score'] as List<dynamic>?)?.map((e) => e as int).toList(),
      sensitivity: (json['sensitivity'] as List<dynamic>?)?.map((e) => e as num).toList(),
    );
    }
