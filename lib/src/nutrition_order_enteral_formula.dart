...
class NutritionOrderEnteralFormula extends BackboneElement implements FhirResource {
  ...
  factory NutritionOrderEnteralFormula.fromJson(Map<String, dynamic> json) {
    return NutritionOrderEnteralFormula(
      ...
      additiveType: json['additiveType'] != null ? CodeableConcept.fromJson(json['additiveType'] as Map<String, dynamic>) : null,
      administration: (json['administration'] as List<dynamic>?)?.map((e) => NutritionOrderEnteralFormulaAdministration.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      baseFormulaType: json['baseFormulaType'] != null ? CodeableConcept.fromJson(json['baseFormulaType'] as Map<String, dynamic>) : null,
      caloricDensity: json['caloricDensity'] != null ? Quantity.fromJson(json['caloricDensity'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      maxVolumeToDeliver: json['maxVolumeToDeliver'] != null ? Quantity.fromJson(json['maxVolumeToDeliver'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      routeofAdministration: json['routeofAdministration'] != null ? CodeableConcept.fromJson(json['routeofAdministration'] as Map<String, dynamic>) : null,
    );
    }
  ...
  NutritionOrderEnteralFormula copyWith({
    ...
    return NutritionOrderEnteralFormula(
      ...
      administrationInstruction: administrationInstruction ?? this.administrationInstruction,
      baseFormulaProductName: baseFormulaProductName ?? this.baseFormulaProductName,
