...
class CoverageCostToBeneficiary extends BackboneElement implements FhirResource {
  ...
  factory CoverageCostToBeneficiary.fromJson(Map<String, dynamic> json) {
    return CoverageCostToBeneficiary(
      exception: (json['exception'] as List<dynamic>?)?.map((e) => CoverageCostToBeneficiaryException.fromJson(e as Map<String, dynamic>)).toList(),
