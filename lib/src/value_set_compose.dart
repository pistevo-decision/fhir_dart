...
class ValueSetCompose extends BackboneElement implements FhirResource {
  ...
  factory ValueSetCompose.fromJson(Map<String, dynamic> json) {
    return ValueSetCompose(
      exclude: (json['exclude'] as List<dynamic>?)?.map((e) => ValueSetComposeInclude.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      inactive: json['inactive'] as bool?,
      include: (json['include'] as List<dynamic>).map((e) => ValueSetComposeInclude.fromJson(e as Map<String, dynamic>)).toList(),
