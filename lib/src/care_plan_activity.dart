...
class CarePlanActivity extends BackboneElement implements FhirResource {
  ...
  factory CarePlanActivity.fromJson(Map<String, dynamic> json) {
    return CarePlanActivity(
      detail: json['detail'] != null ? CarePlanActivityDetail.fromJson(json['detail'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      outcomeCodeableConcept: (json['outcomeCodeableConcept'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      outcomeReference: (json['outcomeReference'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      progress: (json['progress'] as List<dynamic>?)?.map((e) => Annotation.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'outcomeCodeableConcept': outcomeCodeableConcept?.map((e) => e.toJson()).toList(),
  ...
  CarePlanActivity copyWith({
    ...
    return CarePlanActivity(
      ...
      outcomeCodeableConcept: outcomeCodeableConcept ?? this.outcomeCodeableConcept,
