...
class MedicationKnowledge extends DomainResource implements FhirResource {
  ...
  factory MedicationKnowledge.fromJson(Map<String, dynamic> json) {
    return MedicationKnowledge(
      administrationGuidelines: (json['administrationGuidelines'] as List<dynamic>?)?.map((e) => MedicationKnowledgeAdministrationGuidelines.fromJson(e as Map<String, dynamic>)).toList(),
      amount: json['amount'] != null ? Quantity.fromJson(json['amount'] as Map<String, dynamic>) : null,
      associatedMedication: (json['associatedMedication'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      contraindication: (json['contraindication'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      cost: (json['cost'] as List<dynamic>?)?.map((e) => MedicationKnowledgeCost.fromJson(e as Map<String, dynamic>)).toList(),
      doseForm: json['doseForm'] != null ? CodeableConcept.fromJson(json['doseForm'] as Map<String, dynamic>) : null,
      drugCharacteristic: (json['drugCharacteristic'] as List<dynamic>?)?.map((e) => MedicationKnowledgeDrugCharacteristic.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      implicitRules: json['implicitRules'] as String?,
      ingredient: (json['ingredient'] as List<dynamic>?)?.map((e) => MedicationKnowledgeIngredient.fromJson(e as Map<String, dynamic>)).toList(),
      intendedRoute: (json['intendedRoute'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      kinetics: (json['kinetics'] as List<dynamic>?)?.map((e) => MedicationKnowledgeKinetics.fromJson(e as Map<String, dynamic>)).toList(),
      language: json['language'] as String?,
      manufacturer: json['manufacturer'] != null ? Reference.fromJson(json['manufacturer'] as Map<String, dynamic>) : null,
      medicineClassification: (json['medicineClassification'] as List<dynamic>?)?.map((e) => MedicationKnowledgeMedicineClassification.fromJson(e as Map<String, dynamic>)).toList(),
      meta: json['meta'] != null ? Meta.fromJson(json['meta'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      monitoringProgram: (json['monitoringProgram'] as List<dynamic>?)?.map((e) => MedicationKnowledgeMonitoringProgram.fromJson(e as Map<String, dynamic>)).toList(),
      monograph: (json['monograph'] as List<dynamic>?)?.map((e) => MedicationKnowledgeMonograph.fromJson(e as Map<String, dynamic>)).toList(),
      packaging: json['packaging'] != null ? MedicationKnowledgePackaging.fromJson(json['packaging'] as Map<String, dynamic>) : null,
      preparationInstruction: json['preparationInstruction'] as String?,
      productType: (json['productType'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      regulatory: (json['regulatory'] as List<dynamic>?)?.map((e) => MedicationKnowledgeRegulatory.fromJson(e as Map<String, dynamic>)).toList(),
      relatedMedicationKnowledge: (json['relatedMedicationKnowledge'] as List<dynamic>?)?.map((e) => MedicationKnowledgeRelatedMedicationKnowledge.fromJson(e as Map<String, dynamic>)).toList(),
      status: json['status'] as String?,
      synonym: (json['synonym'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      'administrationGuidelines': administrationGuidelines?.map((e) => e.toJson()).toList(),
      'amount': amount?.toJson(),
      'associatedMedication': associatedMedication?.map((e) => e.toJson()).toList(),
      'code': code?.toJson(),
      'contained': contained?.map((e) => e.toJson()).toList(),
      'contraindication': contraindication?.map((e) => e.toJson()).toList(),
      'cost': cost?.map((e) => e.toJson()).toList(),
      'doseForm': doseForm?.toJson(),
      'drugCharacteristic': drugCharacteristic?.map((e) => e.toJson()).toList(),
      ...
      'medicineClassification': medicineClassification?.map((e) => e.toJson()).toList(),
      'meta': meta?.toJson(),
      ...
      'relatedMedicationKnowledge': relatedMedicationKnowledge?.map((e) => e.toJson()).toList(),
      'status': status,
  ...
  MedicationKnowledge copyWith({
    ...
    return MedicationKnowledge(
      administrationGuidelines: administrationGuidelines ?? this.administrationGuidelines,
      ...
      medicineClassification: medicineClassification ?? this.medicineClassification,
      meta: meta ?? this.meta,
      modifierExtension: modifierExtension ?? this.modifierExtension,
      monitoringProgram: monitoringProgram ?? this.monitoringProgram,
      monograph: monograph ?? this.monograph,
      packaging: packaging ?? this.packaging,
      preparationInstruction: preparationInstruction ?? this.preparationInstruction,
      productType: productType ?? this.productType,
      regulatory: regulatory ?? this.regulatory,
      relatedMedicationKnowledge: relatedMedicationKnowledge ?? this.relatedMedicationKnowledge,
