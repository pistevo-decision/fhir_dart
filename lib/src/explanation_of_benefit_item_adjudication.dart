...
class ExplanationOfBenefitItemAdjudication extends BackboneElement implements FhirResource {
  ...
  @override
  factory ExplanationOfBenefitItemAdjudication.fromJson(Map<String, dynamic> json) {
  ...
  @override
  ExplanationOfBenefitItemAdjudication copyWith({
    Money? amount,
