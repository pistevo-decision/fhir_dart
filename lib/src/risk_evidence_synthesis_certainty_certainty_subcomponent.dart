...
class RiskEvidenceSynthesisCertaintyCertaintySubcomponent extends BackboneElement implements FhirResource {
  ...
  @override
  factory RiskEvidenceSynthesisCertaintyCertaintySubcomponent.fromJson(Map<String, dynamic> json) {
  ...
  @override
  RiskEvidenceSynthesisCertaintyCertaintySubcomponent copyWith({
