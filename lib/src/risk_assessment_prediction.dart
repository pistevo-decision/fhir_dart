...
class RiskAssessmentPrediction extends BackboneElement implements FhirResource {
  ...
  factory RiskAssessmentPrediction.fromJson(Map<String, dynamic> json) {
    return RiskAssessmentPrediction(
      ...
      probabilityRange: json['probabilityRange'] != null ? Range.fromJson(json['probabilityRange'] as Map<String, dynamic>) : null,
      qualitativeRisk: json['qualitativeRisk'] != null ? CodeableConcept.fromJson(json['qualitativeRisk'] as Map<String, dynamic>) : null,
      rationale: json['rationale'] as String?,
      relativeRisk: json['relativeRisk'] as num?,
      whenPeriod: json['whenPeriod'] != null ? Period.fromJson(json['whenPeriod'] as Map<String, dynamic>) : null,
      whenRange: json['whenRange'] != null ? Range.fromJson(json['whenRange'] as Map<String, dynamic>) : null,
    );
    }
