...
class MolecularSequenceStructureVariantInner extends BackboneElement implements FhirResource {
  ...
  @override
  factory MolecularSequenceStructureVariantInner.fromJson(Map<String, dynamic> json) {
