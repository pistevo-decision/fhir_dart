...
class CapabilityStatementMessaging extends BackboneElement implements FhirResource {
  ...
  factory CapabilityStatementMessaging.fromJson(Map<String, dynamic> json) {
    return CapabilityStatementMessaging(
      ...
      endpoint: (json['endpoint'] as List<dynamic>?)?.map((e) => CapabilityStatementMessagingEndpoint.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      reliableCache: json['reliableCache'] as int?,
      supportedMessage: (json['supportedMessage'] as List<dynamic>?)?.map((e) => CapabilityStatementMessagingSupportedMessage.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
