...
class ContractTermOffer extends BackboneElement implements FhirResource {
  ...
  factory ContractTermOffer.fromJson(Map<String, dynamic> json) {
    return ContractTermOffer(
      ...
      decision: json['decision'] != null ? CodeableConcept.fromJson(json['decision'] as Map<String, dynamic>) : null,
      decisionMode: (json['decisionMode'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      party: (json['party'] as List<dynamic>?)?.map((e) => ContractTermOfferParty.fromJson(e as Map<String, dynamic>)).toList(),
      securityLabelNumber: (json['securityLabelNumber'] as List<dynamic>?)?.map((e) => e as int).toList(),
      text: json['text'] as String?,
      topic: json['topic'] != null ? Reference.fromJson(json['topic'] as Map<String, dynamic>) : null,
