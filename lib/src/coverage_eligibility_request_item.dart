...
class CoverageEligibilityRequestItem extends BackboneElement implements FhirResource {
  ...
  factory CoverageEligibilityRequestItem.fromJson(Map<String, dynamic> json) {
    return CoverageEligibilityRequestItem(
      ...
      diagnosis: (json['diagnosis'] as List<dynamic>?)?.map((e) => CoverageEligibilityRequestItemDiagnosis.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      supportingInfoSequence: (json['supportingInfoSequence'] as List<dynamic>?)?.map((e) => e as int).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'supportingInfoSequence': supportingInfoSequence?.map((e) => e).toList(),
  ...
  CoverageEligibilityRequestItem copyWith({
    ...
    return CoverageEligibilityRequestItem(
      ...
      supportingInfoSequence: supportingInfoSequence ?? this.supportingInfoSequence,
