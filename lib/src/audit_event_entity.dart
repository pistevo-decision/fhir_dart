...
class AuditEventEntity extends BackboneElement implements FhirResource {
  ...
  factory AuditEventEntity.fromJson(Map<String, dynamic> json) {
    return AuditEventEntity(
      ...
      detail: (json['detail'] as List<dynamic>?)?.map((e) => AuditEventEntityDetail.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      lifecycle: json['lifecycle'] != null ? Coding.fromJson(json['lifecycle'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      name: json['name'] as String?,
      query: json['query'] as String?,
      role: json['role'] != null ? Coding.fromJson(json['role'] as Map<String, dynamic>) : null,
      ...
      what: json['what'] != null ? Reference.fromJson(json['what'] as Map<String, dynamic>) : null,
    );
    }
