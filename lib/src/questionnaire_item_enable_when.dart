...
class QuestionnaireItemEnableWhen extends BackboneElement implements FhirResource {
  ...
  final String fhirOperator; // Possible values: 'exists', '=', '!=', '>', '<', '>=', '<='
  ...
  factory QuestionnaireItemEnableWhen.fromJson(Map<String, dynamic> json) {
    return QuestionnaireItemEnableWhen(
      ...
      answerCoding: json['answerCoding'] != null ? Coding.fromJson(json['answerCoding'] as Map<String, dynamic>) : null,
      ...
      answerQuantity: json['answerQuantity'] != null ? Quantity.fromJson(json['answerQuantity'] as Map<String, dynamic>) : null,
      answerReference: json['answerReference'] != null ? Reference.fromJson(json['answerReference'] as Map<String, dynamic>) : null,
