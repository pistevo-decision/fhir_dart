...
class ClaimResponseAddItemDetailSubDetail extends BackboneElement implements FhirResource {
  ...
  @override
  factory ClaimResponseAddItemDetailSubDetail.fromJson(Map<String, dynamic> json) {
  ...
  @override
  ClaimResponseAddItemDetailSubDetail copyWith({
