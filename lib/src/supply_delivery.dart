...
class SupplyDelivery extends DomainResource implements FhirResource {
  ...
  final String? status; // Possible values: 'in-progress', 'completed', 'abandoned', 'entered-in-error'
  ...
  factory SupplyDelivery.fromJson(Map<String, dynamic> json) {
    return SupplyDelivery(
      ...
      suppliedItem: json['suppliedItem'] != null ? SupplyDeliverySuppliedItem.fromJson(json['suppliedItem'] as Map<String, dynamic>) : null,
      supplier: json['supplier'] != null ? Reference.fromJson(json['supplier'] as Map<String, dynamic>) : null,
