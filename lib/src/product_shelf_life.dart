...
class ProductShelfLife extends BackboneElement implements FhirResource {
  ...
  factory ProductShelfLife.fromJson(Map<String, dynamic> json) {
    return ProductShelfLife(
      ...
      specialPrecautionsForStorage: (json['specialPrecautionsForStorage'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'specialPrecautionsForStorage': specialPrecautionsForStorage?.map((e) => e.toJson()).toList(),
      'type': type.toJson(),
    };
  ...
  ProductShelfLife copyWith({
    ...
    return ProductShelfLife(
      ...
      specialPrecautionsForStorage: specialPrecautionsForStorage ?? this.specialPrecautionsForStorage,
      type: type ?? this.type,
    );
  }
}
