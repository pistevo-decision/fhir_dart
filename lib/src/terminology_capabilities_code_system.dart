...
class TerminologyCapabilitiesCodeSystem extends BackboneElement implements FhirResource {
  ...
  factory TerminologyCapabilitiesCodeSystem.fromJson(Map<String, dynamic> json) {
    return TerminologyCapabilitiesCodeSystem(
      ...
      version: (json['version'] as List<dynamic>?)?.map((e) => TerminologyCapabilitiesCodeSystemVersion.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
