...
class ChargeItem extends DomainResource implements FhirResource {
  ...
  static const resourceType = 'ChargeItem';
  ...
  final String status; // Possible values: 'planned', 'billable', 'not-billable', 'aborted', 'billed', 'entered-in-error', 'unknown'
  ...
  factory ChargeItem.fromJson(Map<String, dynamic> json) {
    return ChargeItem(
      account: (json['account'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      costCenter: json['costCenter'] != null ? Reference.fromJson(json['costCenter'] as Map<String, dynamic>) : null,
      definitionCanonical: (json['definitionCanonical'] as List<dynamic>?)?.map((e) => e as String).toList(),
      definitionUri: (json['definitionUri'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      performer: (json['performer'] as List<dynamic>?)?.map((e) => ChargeItemPerformer.fromJson(e as Map<String, dynamic>)).toList(),
      performingOrganization: json['performingOrganization'] != null ? Reference.fromJson(json['performingOrganization'] as Map<String, dynamic>) : null,
      priceOverride: json['priceOverride'] != null ? Money.fromJson(json['priceOverride'] as Map<String, dynamic>) : null,
      ...
      reason: (json['reason'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      requestingOrganization: json['requestingOrganization'] != null ? Reference.fromJson(json['requestingOrganization'] as Map<String, dynamic>) : null,
      service: (json['service'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  ChargeItem copyWith({
    ...
    return ChargeItem(
      ...
      performingOrganization: performingOrganization ?? this.performingOrganization,
      ...
      requestingOrganization: requestingOrganization ?? this.requestingOrganization,
