...
class MedicinalProductUndesirableEffect extends DomainResource implements FhirResource {
  ...
  factory MedicinalProductUndesirableEffect.fromJson(Map<String, dynamic> json) {
    return MedicinalProductUndesirableEffect(
      classification: json['classification'] != null ? CodeableConcept.fromJson(json['classification'] as Map<String, dynamic>) : null,
      contained: (json['contained'] as List<dynamic>?)?.map((e) => Resource.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      frequencyOfOccurrence: json['frequencyOfOccurrence'] != null ? CodeableConcept.fromJson(json['frequencyOfOccurrence'] as Map<String, dynamic>) : null,
      ...
      symptomConditionEffect: json['symptomConditionEffect'] != null ? CodeableConcept.fromJson(json['symptomConditionEffect'] as Map<String, dynamic>) : null,
  ...
  MedicinalProductUndesirableEffect copyWith({
    ...
    return MedicinalProductUndesirableEffect(
      ...
      frequencyOfOccurrence: frequencyOfOccurrence ?? this.frequencyOfOccurrence,
      id: id ?? this.id,
      ...
      symptomConditionEffect: symptomConditionEffect ?? this.symptomConditionEffect,
      text: text ?? this.text,
    );
  }
}
