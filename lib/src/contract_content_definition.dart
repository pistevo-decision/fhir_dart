...
class ContractContentDefinition extends BackboneElement
  ...
  final String
      publicationStatus; // Possible values: 'amended', 'appended', 'cancelled', 'disputed', 'entered-in-error', 'executable', 'executed', 'negotiable', 'offered', 'policy', 'rejected', 'renewed', 'revoked', 'resolved', 'terminated'
  /// Publisher Entity
