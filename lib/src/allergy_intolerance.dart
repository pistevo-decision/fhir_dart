...
class AllergyIntolerance extends DomainResource implements FhirResource {
  ...
  final List<String>? category; // Possible values: 'food', 'medication', 'environment', 'biologic'
  ...
  final String? criticality; // Possible values: 'low', 'high', 'unable-to-assess'
  ...
  factory AllergyIntolerance.fromJson(Map<String, dynamic> json) {
    return AllergyIntolerance(
      ...
      reaction: (json['reaction'] as List<dynamic>?)?.map((e) => AllergyIntoleranceReaction.fromJson(e as Map<String, dynamic>)).toList(),
