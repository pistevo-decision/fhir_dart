...
class StructureMapGroupRuleTarget extends BackboneElement implements FhirResource {
  ...
  final List<String>? listMode; // Possible values: 'first', 'share', 'last', 'collate'
  ...
  final String? transform; // Possible values: 'create', 'copy', 'truncate', 'escape', 'cast', 'append', 'translate', 'reference', 'dateOp', 'uuid', 'pointer', 'evaluate', 'cc', 'c', 'qty', 'id', 'cp'
  ...
  factory StructureMapGroupRuleTarget.fromJson(Map<String, dynamic> json) {
    return StructureMapGroupRuleTarget(
      ...
      listMode: (json['listMode'] as List<dynamic>?)?.map((e) => e as String).toList(),
      listRuleId: json['listRuleId'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => StructureMapGroupRuleTargetParameter.fromJson(e as Map<String, dynamic>)).toList(),
