...
class SubstanceSourceMaterialOrganismAuthor extends BackboneElement implements FhirResource {
  ...
  @override
  factory SubstanceSourceMaterialOrganismAuthor.fromJson(Map<String, dynamic> json) {
    return SubstanceSourceMaterialOrganismAuthor(
      authorDescription: json['authorDescription'] as String?,
      authorType: json['authorType'] != null ? CodeableConcept.fromJson(json['authorType'] as Map<String, dynamic>) : null,
