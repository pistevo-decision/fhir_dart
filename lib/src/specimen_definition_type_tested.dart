...
class SpecimenDefinitionTypeTested extends BackboneElement implements FhirResource {
  ...
  factory SpecimenDefinitionTypeTested.fromJson(Map<String, dynamic> json) {
    return SpecimenDefinitionTypeTested(
      container: json['container'] != null ? SpecimenDefinitionTypeTestedContainer.fromJson(json['container'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      handling: (json['handling'] as List<dynamic>?)?.map((e) => SpecimenDefinitionTypeTestedHandling.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      isDerived: json['isDerived'] as bool?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      preference: json['preference'] as String,
      rejectionCriterion: (json['rejectionCriterion'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      requirement: json['requirement'] as String?,
      retentionTime: json['retentionTime'] != null ? Duration.fromJson(json['retentionTime'] as Map<String, dynamic>) : null,
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'rejectionCriterion': rejectionCriterion?.map((e) => e.toJson()).toList(),
