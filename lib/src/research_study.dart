...
class ResearchStudy extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'active', 'administratively-completed', 'approved', 'closed-to-accrual', 'closed-to-accrual-and-intervention', 'completed', 'disapproved', 'in-review', 'temporarily-closed-to-accrual', 'temporarily-closed-to-accrual-and-intervention', 'withdrawn'
   /// Name for this study
  ...
  factory ResearchStudy.fromJson(Map<String, dynamic> json) {
    return ResearchStudy(
      arm: (json['arm'] as List<dynamic>?)?.map((e) => ResearchStudyArm.fromJson(e as Map<String, dynamic>)).toList(),
      category: (json['category'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      condition: (json['condition'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      enrollment: (json['enrollment'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      focus: (json['focus'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      identifier: (json['identifier'] as List<dynamic>?)?.map((e) => Identifier.fromJson(e as Map<String, dynamic>)).toList(),
      implicitRules: json['implicitRules'] as String?,
      keyword: (json['keyword'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      language: json['language'] as String?,
      location: (json['location'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      objective: (json['objective'] as List<dynamic>?)?.map((e) => ResearchStudyObjective.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      phase: json['phase'] != null ? CodeableConcept.fromJson(json['phase'] as Map<String, dynamic>) : null,
      primaryPurposeType: json['primaryPurposeType'] != null ? CodeableConcept.fromJson(json['primaryPurposeType'] as Map<String, dynamic>) : null,
      principalInvestigator: json['principalInvestigator'] != null ? Reference.fromJson(json['principalInvestigator'] as Map<String, dynamic>) : null,
      protocol: (json['protocol'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      reasonStopped: json['reasonStopped'] != null ? CodeableConcept.fromJson(json['reasonStopped'] as Map<String, dynamic>) : null,
      ...
      sponsor: json['sponsor'] != null ? Reference.fromJson(json['sponsor'] as Map<String, dynamic>) : null,
