...
class CoverageEligibilityResponse extends DomainResource implements FhirResource {
  ...
  factory CoverageEligibilityResponse.fromJson(Map<String, dynamic> json) {
    return CoverageEligibilityResponse(
      ...
      error: (json['error'] as List<dynamic>?)?.map((e) => CoverageEligibilityResponseError.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      insurance: (json['insurance'] as List<dynamic>?)?.map((e) => CoverageEligibilityResponseInsurance.fromJson(e as Map<String, dynamic>)).toList(),
