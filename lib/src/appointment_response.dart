...
class AppointmentResponse extends DomainResource implements FhirResource {
  ...
  final String participantStatus; // Possible values: 'accepted', 'declined', 'tentative', 'needs-action'
  ...
  factory AppointmentResponse.fromJson(Map<String, dynamic> json) {
    return AppointmentResponse(
      ...
      participantType: (json['participantType'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
