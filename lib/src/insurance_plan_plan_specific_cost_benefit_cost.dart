...
class InsurancePlanPlanSpecificCostBenefitCost extends BackboneElement implements FhirResource {
  ...
  @override
  factory InsurancePlanPlanSpecificCostBenefitCost.fromJson(Map<String, dynamic> json) {
    return InsurancePlanPlanSpecificCostBenefitCost(
      applicability: json['applicability'] != null ? CodeableConcept.fromJson(json['applicability'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      qualifiers: (json['qualifiers'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
