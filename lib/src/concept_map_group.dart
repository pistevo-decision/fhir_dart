...
class ConceptMapGroup extends BackboneElement implements FhirResource {
  ...
  factory ConceptMapGroup.fromJson(Map<String, dynamic> json) {
    return ConceptMapGroup(
      element: (json['element'] as List<dynamic>).map((e) => ConceptMapGroupElement.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      unmapped: json['unmapped'] != null ? ConceptMapGroupUnmapped.fromJson(json['unmapped'] as Map<String, dynamic>) : null,
    );
    }
