...
class CoverageEligibilityResponseInsurance extends BackboneElement implements FhirResource {
  ...
  factory CoverageEligibilityResponseInsurance.fromJson(Map<String, dynamic> json) {
    return CoverageEligibilityResponseInsurance(
      ...
      item: (json['item'] as List<dynamic>?)?.map((e) => CoverageEligibilityResponseInsuranceItem.fromJson(e as Map<String, dynamic>)).toList(),
