...
class ImplementationGuideManifestResource extends BackboneElement implements FhirResource {
  ...
  @override
  factory ImplementationGuideManifestResource.fromJson(Map<String, dynamic> json) {
