...
class TestReport extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'completed', 'in-progress', 'waiting', 'stopped', 'entered-in-error'
  ...
  factory TestReport.fromJson(Map<String, dynamic> json) {
    return TestReport(
      ...
      participant: (json['participant'] as List<dynamic>?)?.map((e) => TestReportParticipant.fromJson(e as Map<String, dynamic>)).toList(),
      result: json['result'] as String,
      score: json['score'] as num?,
      setup: json['setup'] != null ? TestReportSetup.fromJson(json['setup'] as Map<String, dynamic>) : null,
      status: json['status'] as String,
      teardown: json['teardown'] != null ? TestReportTeardown.fromJson(json['teardown'] as Map<String, dynamic>) : null,
      test: (json['test'] as List<dynamic>?)?.map((e) => TestReportTest.fromJson(e as Map<String, dynamic>)).toList(),
