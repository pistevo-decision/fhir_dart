...
class TestReportSetupAction extends BackboneElement implements FhirResource {
  ...
  factory TestReportSetupAction.fromJson(Map<String, dynamic> json) {
    return TestReportSetupAction(
      fhirAssert: json['assert'] != null ? TestReportSetupActionAssert.fromJson(json['assert'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      operation: json['operation'] != null ? TestReportSetupActionOperation.fromJson(json['operation'] as Map<String, dynamic>) : null,
    );
    }
