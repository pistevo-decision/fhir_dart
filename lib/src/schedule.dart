...
class Schedule extends DomainResource implements FhirResource {
  ...
  factory Schedule.fromJson(Map<String, dynamic> json) {
    return Schedule(
      ...
      actor: (json['actor'] as List<dynamic>).map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      planningHorizon: json['planningHorizon'] != null ? Period.fromJson(json['planningHorizon'] as Map<String, dynamic>) : null,
