...
class ExplanationOfBenefitAddItem extends BackboneElement implements FhirResource {
  ...
  factory ExplanationOfBenefitAddItem.fromJson(Map<String, dynamic> json) {
    return ExplanationOfBenefitAddItem(
      ...
      detail: (json['detail'] as List<dynamic>?)?.map((e) => ExplanationOfBenefitAddItemDetail.fromJson(e as Map<String, dynamic>)).toList(),
      detailSequence: (json['detailSequence'] as List<dynamic>?)?.map((e) => e as int).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      factor: json['factor'] as num?,
      id: json['id'] as String?,
      itemSequence: (json['itemSequence'] as List<dynamic>?)?.map((e) => e as int).toList(),
      ...
      provider: (json['provider'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      subDetailSequence: (json['subDetailSequence'] as List<dynamic>?)?.map((e) => e as int).toList(),
