...
class ExplanationOfBenefitSupportingInfo extends BackboneElement implements FhirResource {
  ...
  factory ExplanationOfBenefitSupportingInfo.fromJson(Map<String, dynamic> json) {
    return ExplanationOfBenefitSupportingInfo(
      ...
      reason: json['reason'] != null ? Coding.fromJson(json['reason'] as Map<String, dynamic>) : null,
