...
class MedicationKnowledgeKinetics extends BackboneElement implements FhirResource {
  ...
  factory MedicationKnowledgeKinetics.fromJson(Map<String, dynamic> json) {
    return MedicationKnowledgeKinetics(
      areaUnderCurve: (json['areaUnderCurve'] as List<dynamic>?)?.map((e) => Quantity.fromJson(e as Map<String, dynamic>)).toList(),
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      halfLifePeriod: json['halfLifePeriod'] != null ? Duration.fromJson(json['halfLifePeriod'] as Map<String, dynamic>) : null,
      id: json['id'] as String?,
      lethalDose50: (json['lethalDose50'] as List<dynamic>?)?.map((e) => Quantity.fromJson(e as Map<String, dynamic>)).toList(),
