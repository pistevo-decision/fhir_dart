...
class MedicationKnowledgeRegulatory extends BackboneElement implements FhirResource {
  ...
  factory MedicationKnowledgeRegulatory.fromJson(Map<String, dynamic> json) {
    return MedicationKnowledgeRegulatory(
      ...
      maxDispense: json['maxDispense'] != null ? MedicationKnowledgeRegulatoryMaxDispense.fromJson(json['maxDispense'] as Map<String, dynamic>) : null,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      regulatoryAuthority: Reference.fromJson(json['regulatoryAuthority'] as Map<String, dynamic>),
      schedule: (json['schedule'] as List<dynamic>?)?.map((e) => MedicationKnowledgeRegulatorySchedule.fromJson(e as Map<String, dynamic>)).toList(),
      substitution: (json['substitution'] as List<dynamic>?)?.map((e) => MedicationKnowledgeRegulatorySubstitution.fromJson(e as Map<String, dynamic>)).toList(),
    );
    }
