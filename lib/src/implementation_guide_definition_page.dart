...
class ImplementationGuideDefinitionPage extends BackboneElement implements FhirResource {
   /// A code that indicates how the page is generated.
  final String generation; // Possible values: 'html', 'markdown', 'xml', 'generated'
  ...
  @override
  factory ImplementationGuideDefinitionPage.fromJson(Map<String, dynamic> json) {
    return ImplementationGuideDefinitionPage(
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      generation: json['generation'] as String,
      id: json['id'] as String?,
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      nameReference: json['nameReference'] != null ? Reference.fromJson(json['nameReference'] as Map<String, dynamic>) : null,
      nameUrl: json['nameUrl'] as String?,
      page: (json['page'] as List<dynamic>?)?.map((e) => ImplementationGuideDefinitionPage.fromJson(e as Map<String, dynamic>)).toList(),
