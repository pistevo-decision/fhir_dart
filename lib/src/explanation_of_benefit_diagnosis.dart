...
class ExplanationOfBenefitDiagnosis extends BackboneElement implements FhirResource {
  ...
  factory ExplanationOfBenefitDiagnosis.fromJson(Map<String, dynamic> json) {
    return ExplanationOfBenefitDiagnosis(
      ...
      onAdmission: json['onAdmission'] != null ? CodeableConcept.fromJson(json['onAdmission'] as Map<String, dynamic>) : null,
      packageCode: json['packageCode'] != null ? CodeableConcept.fromJson(json['packageCode'] as Map<String, dynamic>) : null,
