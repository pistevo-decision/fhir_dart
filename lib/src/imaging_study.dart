...
class ImagingStudy extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'registered', 'available', 'cancelled', 'entered-in-error', 'unknown'
  ...
  factory ImagingStudy.fromJson(Map<String, dynamic> json) {
    return ImagingStudy(
      ...
      interpreter: (json['interpreter'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      modality: (json['modality'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      procedureCode: (json['procedureCode'] as List<dynamic>?)?.map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      referrer: json['referrer'] != null ? Reference.fromJson(json['referrer'] as Map<String, dynamic>) : null,
      series: (json['series'] as List<dynamic>?)?.map((e) => ImagingStudySeries.fromJson(e as Map<String, dynamic>)).toList(),
