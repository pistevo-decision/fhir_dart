...
class Account extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'active', 'inactive', 'entered-in-error', 'on-hold', 'unknown'
  ...
  factory Account.fromJson(Map<String, dynamic> json) {
    return Account(
      ...
      coverage: (json['coverage'] as List<dynamic>?)?.map((e) => AccountCoverage.fromJson(e as Map<String, dynamic>)).toList(),
      description: json['description'] as String?,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      guarantor: (json['guarantor'] as List<dynamic>?)?.map((e) => AccountGuarantor.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      servicePeriod: json['servicePeriod'] != null ? Period.fromJson(json['servicePeriod'] as Map<String, dynamic>) : null,
