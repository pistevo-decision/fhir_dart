...
class ImplementationGuideDefinitionResource extends BackboneElement implements FhirResource {
  ...
  @override
  factory ImplementationGuideDefinitionResource.fromJson(Map<String, dynamic> json) {
