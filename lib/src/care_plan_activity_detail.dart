...
class CarePlanActivityDetail extends BackboneElement implements FhirResource {
  ...
  final String? kind; // Possible values: 'Appointment', 'CommunicationRequest', 'DeviceRequest', 'MedicationRequest', 'NutritionOrder', 'Task', 'ServiceRequest', 'VisionPrescription'
  ...
  final String status; // Possible values: 'not-started', 'scheduled', 'in-progress', 'on-hold', 'completed', 'cancelled', 'stopped', 'unknown', 'entered-in-error'
  ...
  factory CarePlanActivityDetail.fromJson(Map<String, dynamic> json) {
    return CarePlanActivityDetail(
      ...
      dailyAmount: json['dailyAmount'] != null ? Quantity.fromJson(json['dailyAmount'] as Map<String, dynamic>) : null,
      description: json['description'] as String?,
      doNotPerform: json['doNotPerform'] as bool?,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      goal: (json['goal'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      scheduledPeriod: json['scheduledPeriod'] != null ? Period.fromJson(json['scheduledPeriod'] as Map<String, dynamic>) : null,
      scheduledString: json['scheduledString'] as String?,
      scheduledTiming: json['scheduledTiming'] != null ? Timing.fromJson(json['scheduledTiming'] as Map<String, dynamic>) : null,
