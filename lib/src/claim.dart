...
class Claim extends DomainResource implements FhirResource {
  ...
  factory Claim.fromJson(Map<String, dynamic> json) {
    return Claim(
      accident: json['accident'] != null ? ClaimAccident.fromJson(json['accident'] as Map<String, dynamic>) : null,
      billablePeriod: json['billablePeriod'] != null ? Period.fromJson(json['billablePeriod'] as Map<String, dynamic>) : null,
      careTeam: (json['careTeam'] as List<dynamic>?)?.map((e) => ClaimCareTeam.fromJson(e as Map<String, dynamic>)).toList(),
      contained: (json['contained'] as List<dynamic>?)?.map((e) => Resource.fromJson(e as Map<String, dynamic>)).toList(),
      created: json['created'] as String,
      diagnosis: (json['diagnosis'] as List<dynamic>?)?.map((e) => ClaimDiagnosis.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      insurance: (json['insurance'] as List<dynamic>).map((e) => ClaimInsurance.fromJson(e as Map<String, dynamic>)).toList(),
      insurer: json['insurer'] != null ? Reference.fromJson(json['insurer'] as Map<String, dynamic>) : null,
      item: (json['item'] as List<dynamic>?)?.map((e) => ClaimItem.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      payee: json['payee'] != null ? ClaimPayee.fromJson(json['payee'] as Map<String, dynamic>) : null,
      ...
      procedure: (json['procedure'] as List<dynamic>?)?.map((e) => ClaimProcedure.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      related: (json['related'] as List<dynamic>?)?.map((e) => ClaimRelated.fromJson(e as Map<String, dynamic>)).toList(),
      status: json['status'] as String,
      subType: json['subType'] != null ? CodeableConcept.fromJson(json['subType'] as Map<String, dynamic>) : null,
      supportingInfo: (json['supportingInfo'] as List<dynamic>?)?.map((e) => ClaimSupportingInfo.fromJson(e as Map<String, dynamic>)).toList(),
