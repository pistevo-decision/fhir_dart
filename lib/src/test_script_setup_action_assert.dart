...
class TestScriptSetupActionAssert extends BackboneElement implements FhirResource {
  ...
  final String? fhirOperator; // Possible values: 'equals', 'notEquals', 'in', 'notIn', 'greaterThan', 'lessThan', 'empty', 'notEmpty', 'contains', 'notContains', 'eval'
  ...
  final String? requestMethod; // Possible values: 'delete', 'get', 'options', 'patch', 'post', 'put', 'head'
  ...
  final String? response; // Possible values: 'okay', 'created', 'noContent', 'notModified', 'bad', 'forbidden', 'notFound', 'methodNotAllowed', 'conflict', 'gone', 'preconditionFailed', 'unprocessable'
  ...
  TestScriptSetupActionAssert copyWith({
    ...
    return TestScriptSetupActionAssert(
      compareToSourceExpression: compareToSourceExpression ?? this.compareToSourceExpression,
