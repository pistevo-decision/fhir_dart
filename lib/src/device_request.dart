...
class DeviceRequest extends DomainResource implements FhirResource {
  ...
  factory DeviceRequest.fromJson(Map<String, dynamic> json) {
    return DeviceRequest(
      ...
      codeCodeableConcept: json['codeCodeableConcept'] != null ? CodeableConcept.fromJson(json['codeCodeableConcept'] as Map<String, dynamic>) : null,
      codeReference: json['codeReference'] != null ? Reference.fromJson(json['codeReference'] as Map<String, dynamic>) : null,
      ...
      parameter: (json['parameter'] as List<dynamic>?)?.map((e) => DeviceRequestParameter.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      priorRequest: (json['priorRequest'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
