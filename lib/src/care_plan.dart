...
class CarePlan extends DomainResource implements FhirResource {
  ...
  factory CarePlan.fromJson(Map<String, dynamic> json) {
    return CarePlan(
      activity: (json['activity'] as List<dynamic>?)?.map((e) => CarePlanActivity.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      careTeam: (json['careTeam'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
