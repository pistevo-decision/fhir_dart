...
class ContractTermSecurityLabel extends BackboneElement implements FhirResource {
   /// Applicable Policy
  ...
  factory ContractTermSecurityLabel.fromJson(Map<String, dynamic> json) {
    return ContractTermSecurityLabel(
      category: (json['category'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
      classification: Coding.fromJson(json['classification'] as Map<String, dynamic>),
      control: (json['control'] as List<dynamic>?)?.map((e) => Coding.fromJson(e as Map<String, dynamic>)).toList(),
