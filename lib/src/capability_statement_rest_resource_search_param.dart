...
class CapabilityStatementRestResourceSearchParam extends BackboneElement implements FhirResource {
  ...
  @override
  factory CapabilityStatementRestResourceSearchParam.fromJson(Map<String, dynamic> json) {
