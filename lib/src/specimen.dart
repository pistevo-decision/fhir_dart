...
class Specimen extends DomainResource implements FhirResource {
  ...
  final String? status; // Possible values: 'available', 'unavailable', 'unsatisfactory', 'entered-in-error'
  ...
  factory Specimen.fromJson(Map<String, dynamic> json) {
    return Specimen(
      accessionIdentifier: json['accessionIdentifier'] != null ? Identifier.fromJson(json['accessionIdentifier'] as Map<String, dynamic>) : null,
      collection: json['collection'] != null ? SpecimenCollection.fromJson(json['collection'] as Map<String, dynamic>) : null,
      ...
      container: (json['container'] as List<dynamic>?)?.map((e) => SpecimenContainer.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      processing: (json['processing'] as List<dynamic>?)?.map((e) => SpecimenProcessing.fromJson(e as Map<String, dynamic>)).toList(),
