...
class SubstancePolymerRepeatRepeatUnit extends BackboneElement
  ...
  /// Todo.
  final List<SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation>?
  ...
  /// Todo.
  final List<SubstancePolymerRepeatRepeatUnitStructuralRepresentation>?
  ...
  Map<String, dynamic> toJson() => {
        ...
        'degreeOfPolymerisation':
            degreeOfPolymerisation?.map((e) => e.toJson()).toList(),
        ...
        'structuralRepresentation':
            structuralRepresentation?.map((e) => e.toJson()).toList(),
      };
