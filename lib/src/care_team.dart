...
class CareTeam extends DomainResource implements FhirResource {
  ...
  final String? status; // Possible values: 'proposed', 'active', 'suspended', 'inactive', 'entered-in-error'
  ...
  factory CareTeam.fromJson(Map<String, dynamic> json) {
    return CareTeam(
      ...
      managingOrganization: (json['managingOrganization'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      participant: (json['participant'] as List<dynamic>?)?.map((e) => CareTeamParticipant.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Map<String, dynamic> toJson() =>
    {
      ...
      'language': language,
      'managingOrganization': managingOrganization?.map((e) => e.toJson()).toList(),
      'meta': meta?.toJson(),
