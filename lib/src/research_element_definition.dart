...
class ResearchElementDefinition extends DomainResource implements FhirResource {
  ...
  static const resourceType = 'ResearchElementDefinition';
  ...
  final String? variableType; // Possible values: 'dichotomous', 'continuous', 'descriptive'
  ...
  factory ResearchElementDefinition.fromJson(Map<String, dynamic> json) {
    return ResearchElementDefinition(
      ...
      characteristic: (json['characteristic'] as List<dynamic>).map((e) => ResearchElementDefinitionCharacteristic.fromJson(e as Map<String, dynamic>)).toList(),
