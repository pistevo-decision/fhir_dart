...
class AllergyIntoleranceReaction extends BackboneElement implements FhirResource {
  ...
  factory AllergyIntoleranceReaction.fromJson(Map<String, dynamic> json) {
    return AllergyIntoleranceReaction(
      ...
      exposureRoute: json['exposureRoute'] != null ? CodeableConcept.fromJson(json['exposureRoute'] as Map<String, dynamic>) : null,
      fhirExtension: (json['extension'] as List<dynamic>?)?.map((e) => Extension.fromJson(e as Map<String, dynamic>)).toList(),
      id: json['id'] as String?,
      manifestation: (json['manifestation'] as List<dynamic>).map((e) => CodeableConcept.fromJson(e as Map<String, dynamic>)).toList(),
