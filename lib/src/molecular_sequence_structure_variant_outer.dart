...
class MolecularSequenceStructureVariantOuter extends BackboneElement implements FhirResource {
  ...
  @override
  factory MolecularSequenceStructureVariantOuter.fromJson(Map<String, dynamic> json) {
