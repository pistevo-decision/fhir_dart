...
class OperationDefinitionParameterBinding extends BackboneElement implements FhirResource {
  ...
  @override
  factory OperationDefinitionParameterBinding.fromJson(Map<String, dynamic> json) {
