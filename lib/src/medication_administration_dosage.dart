...
class MedicationAdministrationDosage extends BackboneElement implements FhirResource {
  ...
  factory MedicationAdministrationDosage.fromJson(Map<String, dynamic> json) {
    return MedicationAdministrationDosage(
      dose: json['dose'] != null ? Quantity.fromJson(json['dose'] as Map<String, dynamic>) : null,
