...
class QuestionnaireResponseItem extends BackboneElement implements FhirResource {
  ...
  factory QuestionnaireResponseItem.fromJson(Map<String, dynamic> json) {
    return QuestionnaireResponseItem(
      answer: (json['answer'] as List<dynamic>?)?.map((e) => QuestionnaireResponseItemAnswer.fromJson(e as Map<String, dynamic>)).toList(),
