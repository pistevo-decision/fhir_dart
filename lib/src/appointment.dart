...
class Appointment extends DomainResource implements FhirResource {
  ...
  final String status; // Possible values: 'proposed', 'pending', 'booked', 'arrived', 'fulfilled', 'cancelled', 'noshow', 'entered-in-error', 'checked-in', 'waitlist'
  ...
  factory Appointment.fromJson(Map<String, dynamic> json) {
    return Appointment(
      ...
      cancelationReason: json['cancelationReason'] != null ? CodeableConcept.fromJson(json['cancelationReason'] as Map<String, dynamic>) : null,
      ...
      participant: (json['participant'] as List<dynamic>).map((e) => AppointmentParticipant.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      requestedPeriod: (json['requestedPeriod'] as List<dynamic>?)?.map((e) => Period.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      slot: (json['slot'] as List<dynamic>?)?.map((e) => Reference.fromJson(e as Map<String, dynamic>)).toList(),
