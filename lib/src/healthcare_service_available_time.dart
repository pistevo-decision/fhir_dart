...
class HealthcareServiceAvailableTime extends BackboneElement implements FhirResource {
  ...
  final List<String>? daysOfWeek; // Possible values: 'mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'
