...
class ValueSet extends DomainResource implements FhirResource {
  ...
  factory ValueSet.fromJson(Map<String, dynamic> json) {
    return ValueSet(
      compose: json['compose'] != null ? ValueSetCompose.fromJson(json['compose'] as Map<String, dynamic>) : null,
      ...
      expansion: json['expansion'] != null ? ValueSetExpansion.fromJson(json['expansion'] as Map<String, dynamic>) : null,
