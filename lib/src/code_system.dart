...
class CodeSystem extends DomainResource implements FhirResource {
  ...
  final String content; // Possible values: 'not-present', 'example', 'fragment', 'complete', 'supplement'
  ...
  final String? hierarchyMeaning; // Possible values: 'grouped-by', 'is-a', 'part-of', 'classified-with'
  ...
  factory CodeSystem.fromJson(Map<String, dynamic> json) {
    return CodeSystem(
      ...
      concept: (json['concept'] as List<dynamic>?)?.map((e) => CodeSystemConcept.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      filter: (json['filter'] as List<dynamic>?)?.map((e) => CodeSystemFilter.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      property: (json['property'] as List<dynamic>?)?.map((e) => CodeSystemProperty.fromJson(e as Map<String, dynamic>)).toList(),
